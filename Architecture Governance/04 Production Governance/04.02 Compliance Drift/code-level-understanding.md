# Code-Level Understanding: Compliance Drift

## Example Exercise

Build a small Architecture Governance example that demonstrates Compliance Drift with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Compliance Drift example.
