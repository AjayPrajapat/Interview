# Domain-Specific Examples: Compliance Drift

## Domain Lens

Category domain: security and governance engineering

Use Compliance Drift to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
