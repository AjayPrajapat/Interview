# Core Concepts: Compliance Drift

## Definition

Compliance Drift is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Production Governance.
...
Use Compliance Drift to reason about:
