# Diagrams: 04.02 Compliance Drift

Category: Architecture Governance

Topic: 04 Production Governance

Use these diagrams to understand Compliance Drift visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Compliance Drift Rules"]
...
sequenceDiagram
  ...
  participant Core as Compliance Drift
  participant State
...
Do not optimize Compliance Drift by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Compliance Drift"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Compliance Drift"] --> B{"Clear Owner?"}
