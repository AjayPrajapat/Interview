# Common Misconceptions: Compliance Drift
...
Write one sentence explaining what you used to believe about Compliance Drift, then rewrite it with the production constraint included.
