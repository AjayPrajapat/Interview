# Learning Objectives: Compliance Drift

## By The End, You Should Be Able To

- Define Compliance Drift in the context of Architecture Governance without relying on memorized wording.
- Explain why Compliance Drift belongs under Production Governance and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Compliance Drift.
