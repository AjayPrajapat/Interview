# Validation Questions: Compliance Drift

## Conceptual Questions

1. What problem does Compliance Drift solve in Architecture Governance?
...
1. A production issue appears only under high traffic. How would you investigate Compliance Drift?
...
2. What metric would move first if Compliance Drift became the bottleneck?

## Mastery Prompt

Explain Compliance Drift from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
