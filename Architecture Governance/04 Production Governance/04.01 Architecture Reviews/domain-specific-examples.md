# Domain-Specific Examples: Architecture Reviews

## Domain Lens

Category domain: security and governance engineering

Use Architecture Reviews to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
