# Learning Objectives: Architecture Reviews

## By The End, You Should Be Able To

- Define Architecture Reviews in the context of Architecture Governance without relying on memorized wording.
- Explain why Architecture Reviews belongs under Production Governance and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Architecture Reviews.
