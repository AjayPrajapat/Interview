# Common Misconceptions: Architecture Reviews
...
Write one sentence explaining what you used to believe about Architecture Reviews, then rewrite it with the production constraint included.
