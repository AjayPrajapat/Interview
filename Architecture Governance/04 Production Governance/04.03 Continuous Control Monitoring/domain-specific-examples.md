# Domain-Specific Examples: Continuous Control Monitoring

## Domain Lens

Category domain: security and governance engineering

Use Continuous Control Monitoring to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
...
In Architecture Governance, this example should translate into:
