# Core Concepts: Continuous Control Monitoring

## Definition

Continuous Control Monitoring is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Production Governance.
...
- It gives engineers a shared vocabulary for reasoning about Production Governance.
...
Use Continuous Control Monitoring to reason about:
...
- The Production Governance layer decides which path should execute.
