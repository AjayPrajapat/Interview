# Learning Objectives: Policies and Standards

## By The End, You Should Be Able To

- Define Policies and Standards in the context of Architecture Governance without relying on memorized wording.
- Explain why Policies and Standards belongs under Governance Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Policies and Standards.
