# Domain-Specific Examples: Policies and Standards

## Domain Lens

Category domain: security and governance engineering

Use Policies and Standards to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
