# Domain-Specific Examples: Risk Classification

## Domain Lens

Category domain: security and governance engineering

Use Risk Classification to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
