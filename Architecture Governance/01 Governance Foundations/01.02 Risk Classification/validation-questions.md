# Validation Questions: Risk Classification

## Conceptual Questions

1. What problem does Risk Classification solve in Architecture Governance?
...
1. A production issue appears only under high traffic. How would you investigate Risk Classification?
...
2. What metric would move first if Risk Classification became the bottleneck?

## Mastery Prompt

Explain Risk Classification from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
