# Common Misconceptions: Ownership Model
...
Write one sentence explaining what you used to believe about Ownership Model, then rewrite it with the production constraint included.
