# Code-Level Understanding: Access Controls

## Example Exercise

Build a small Architecture Governance example that demonstrates Access Controls with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Access Controls example.
