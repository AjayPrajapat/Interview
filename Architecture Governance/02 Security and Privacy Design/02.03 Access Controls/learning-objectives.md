# Learning Objectives: Access Controls

## By The End, You Should Be Able To

- Define Access Controls in the context of Architecture Governance without relying on memorized wording.
- Explain why Access Controls belongs under Security and Privacy Design and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Access Controls.
