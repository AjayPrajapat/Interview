# Domain-Specific Examples: Access Controls

## Domain Lens

Category domain: security and governance engineering

Use Access Controls to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
