# Core Concepts: Threat Modeling

## Definition

Threat Modeling is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Security and Privacy Design.
...
Use Threat Modeling to reason about:
