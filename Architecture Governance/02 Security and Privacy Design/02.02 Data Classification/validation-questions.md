# Validation Questions: Data Classification

## Conceptual Questions

1. What problem does Data Classification solve in Architecture Governance?
...
1. A production issue appears only under high traffic. How would you investigate Data Classification?
...
2. What metric would move first if Data Classification became the bottleneck?

## Mastery Prompt

Explain Data Classification from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
