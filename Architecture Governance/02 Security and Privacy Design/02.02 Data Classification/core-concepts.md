# Core Concepts: Data Classification

## Definition

Data Classification is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Security and Privacy Design.
...
- It gives engineers a shared vocabulary for reasoning about Security and Privacy Design.
...
Use Data Classification to reason about:
...
- The Security and Privacy Design layer decides which path should execute.
