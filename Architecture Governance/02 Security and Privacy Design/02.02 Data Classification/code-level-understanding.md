# Code-Level Understanding: Data Classification

## Example Exercise

Build a small Architecture Governance example that demonstrates Data Classification with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Data Classification example.
