# Diagrams: 02.02 Data Classification

Category: Architecture Governance

Topic: 02 Security and Privacy Design

Use these diagrams to understand Data Classification visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.

## 1. Concept Map

```mermaid
flowchart TD
  A["Architecture Governance"] --> B["02 Security and Privacy Design"]
...
flowchart TD
  ...
  C --> D["Apply Data Classification Rules"]
...
```text
Work enters Data Classification
...
sequenceDiagram
  ...
  participant Core as Data Classification
  participant State
...
Do not optimize Data Classification by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Data Classification"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Data Classification"] --> B{"Clear Owner?"}
...
```text
[ ] I can define Data Classification.
