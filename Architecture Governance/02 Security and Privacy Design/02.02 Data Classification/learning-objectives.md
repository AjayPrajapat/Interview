# Learning Objectives: Data Classification

## By The End, You Should Be Able To

- Define Data Classification in the context of Architecture Governance without relying on memorized wording.
- Explain why Data Classification belongs under Security and Privacy Design and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Data Classification.
