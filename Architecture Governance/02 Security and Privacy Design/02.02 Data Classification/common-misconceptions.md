# Common Misconceptions: Data Classification
...
Write one sentence explaining what you used to believe about Data Classification, then rewrite it with the production constraint included.
