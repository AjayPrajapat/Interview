# Domain-Specific Examples: Change Tracking

## Domain Lens

Category domain: security and governance engineering

Use Change Tracking to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
