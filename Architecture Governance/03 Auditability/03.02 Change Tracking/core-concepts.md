# Core Concepts: Change Tracking

## Definition

Change Tracking is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Auditability.
...
Use Change Tracking to reason about:
