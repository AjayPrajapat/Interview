# Learning Objectives: Change Tracking

## By The End, You Should Be Able To

- Define Change Tracking in the context of Architecture Governance without relying on memorized wording.
- Explain why Change Tracking belongs under Auditability and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Change Tracking.
