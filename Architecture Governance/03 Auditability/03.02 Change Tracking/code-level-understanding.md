# Code-Level Understanding: Change Tracking

## Example Exercise

Build a small Architecture Governance example that demonstrates Change Tracking with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Change Tracking example.
