# Domain-Specific Examples: Exception Handling

## Domain Lens

Category domain: security and governance engineering

Use Exception Handling to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
