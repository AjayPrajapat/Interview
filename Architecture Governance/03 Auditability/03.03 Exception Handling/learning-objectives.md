...
- Define Exception Handling in the context of Architecture Governance without relying on memorized wording.
- Explain why Exception Handling belongs under Auditability and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Exception Handling.
