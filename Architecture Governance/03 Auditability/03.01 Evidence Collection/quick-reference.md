...
Evidence Collection is a Architecture Governance concept inside Auditability that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
