# Domain-Specific Examples: Evidence Collection

## Domain Lens

Category domain: security and governance engineering

Use Evidence Collection to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
