# Core Concepts: Evidence Collection

## Definition

Evidence Collection is a core part of Architecture Governance that describes a specific behavior, boundary, or engineering decision inside Auditability.
...
- It gives engineers a shared vocabulary for reasoning about Auditability.
...
Use Evidence Collection to reason about:
...
- The Auditability layer decides which path should execute.
