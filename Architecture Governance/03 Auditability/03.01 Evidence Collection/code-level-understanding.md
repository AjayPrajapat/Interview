# Code-Level Understanding: Evidence Collection

## Example Exercise

Build a small Architecture Governance example that demonstrates Evidence Collection with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Evidence Collection example.
