# Learning Objectives: RFCs

## By The End, You Should Be Able To

- Define RFCs in the context of Staff/Principal Engineer Mindset without relying on memorized wording.
- Explain why RFCs belongs under Communication and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to RFCs.
