# Quick Reference: RFCs

## Core Definition

RFCs is a Staff/Principal Engineer Mindset concept inside Communication that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
