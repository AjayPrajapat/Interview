# Domain-Specific Examples: RFCs

## Domain Lens

Category domain: technical leadership

Use RFCs to reason about a cross-team engineering decision where clarity, influence, trade-offs, delivery risk, and long-term ownership matter.
