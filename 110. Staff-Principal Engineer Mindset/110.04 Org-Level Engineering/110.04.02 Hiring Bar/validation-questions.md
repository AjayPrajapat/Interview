# Validation Questions: Hiring Bar

## Conceptual Questions

1. What problem does Hiring Bar solve in Staff/Principal Engineer Mindset?
...
1. A production issue appears only under high traffic. How would you investigate Hiring Bar?
...
2. What metric would move first if Hiring Bar became the bottleneck?

## Mastery Prompt

Explain Hiring Bar from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
