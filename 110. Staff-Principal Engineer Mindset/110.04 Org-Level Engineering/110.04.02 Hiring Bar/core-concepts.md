# Core Concepts: Hiring Bar

## Definition

Hiring Bar is a core part of Staff/Principal Engineer Mindset that describes a specific behavior, boundary, or engineering decision inside Org-Level Engineering.
...
Use Hiring Bar to reason about:
