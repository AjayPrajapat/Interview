# Diagrams: 110.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Staff/Principal Engineer Mindset"] --> B["110.01 Technical Leadership"]
...
For Staff/Principal Engineer Mindset, pay special attention to:
