# Quick Reference: Decision Making

## Core Definition

Decision Making is a Staff/Principal Engineer Mindset concept inside Technical Leadership that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
