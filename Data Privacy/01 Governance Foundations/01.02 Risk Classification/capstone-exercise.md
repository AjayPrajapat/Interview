# Capstone Exercise: Risk Classification

## Scenario

You own a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align. You must design, implement, test, operate, and explain Risk Classification for a production system.
