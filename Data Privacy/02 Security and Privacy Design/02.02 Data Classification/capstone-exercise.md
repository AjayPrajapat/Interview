# Capstone Exercise: Data Classification

## Scenario

You own a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align. You must design, implement, test, operate, and explain Data Classification for a production system.
