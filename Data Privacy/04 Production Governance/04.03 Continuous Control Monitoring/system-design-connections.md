# System Design Connections: Continuous Control Monitoring

## Connection

Security topics connect to trust boundaries, least privilege, data classification, compliance evidence, and architecture review.

## Design Dimensions

- Boundary: where does Continuous Control Monitoring start and stop?
