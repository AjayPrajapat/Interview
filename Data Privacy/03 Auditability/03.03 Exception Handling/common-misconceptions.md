# Common Misconceptions: Exception Handling
...
Write one sentence explaining what you used to believe about Exception Handling, then rewrite it with the production constraint included.
