# Common Misconceptions: Graceful Degradation
...
Write one sentence explaining what you used to believe about Graceful Degradation, then rewrite it with the production constraint included.
