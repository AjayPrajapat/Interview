# Common Misconceptions: Cost and Reliability Trade-offs

## Misconception 1

Operations starts after deploy. Production engineering starts in design through health checks, observability, capacity, resilience, and rollback.
...
Write one sentence explaining what you used to believe about Cost and Reliability Trade-offs, then rewrite it with the production constraint included.
