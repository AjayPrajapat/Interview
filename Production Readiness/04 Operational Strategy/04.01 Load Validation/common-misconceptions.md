# Common Misconceptions: Load Validation
...
Write one sentence explaining what you used to believe about Load Validation, then rewrite it with the production constraint included.
