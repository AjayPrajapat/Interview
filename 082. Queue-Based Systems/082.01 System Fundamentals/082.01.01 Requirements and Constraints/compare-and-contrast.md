# Compare And Contrast: Requirements and Constraints
...
For Requirements and Constraints, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
