# Capstone Exercise: Requirements and Constraints

## Scenario

You own a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable. You must design, implement, test, operate, and explain Requirements and Constraints for a production system.
