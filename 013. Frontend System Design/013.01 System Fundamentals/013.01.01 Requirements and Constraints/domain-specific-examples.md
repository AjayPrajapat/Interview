...
Use Requirements and Constraints to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
