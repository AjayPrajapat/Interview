...
Trade-off Narratives is a focused engineering concept inside 100.03 Communication. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Architecture Review.
...
In Architecture Review, Trade-off Narratives commonly appears as a service boundary, data flow, queue, topic, cache, database table, API, worker, or consistency model.

Typical shape:

```txt
Trade-off Narratives production flow
...
Trade-off Narratives appears in production anywhere Architecture Review needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Trade-off Narratives, and why does it matter in Architecture Review?
