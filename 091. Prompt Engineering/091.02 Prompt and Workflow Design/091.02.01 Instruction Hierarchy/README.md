...
Topic: 091.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 091.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Prompt Engineering.
...
- reduce ambiguity in 091.02 Prompt and Workflow Design,
...
In Prompt Engineering, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 091.02 Prompt and Workflow Design boundary
...
For Prompt Engineering, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere Prompt Engineering needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in Prompt Engineering?
2. What problem does it solve inside 091.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 091.02 Prompt and Workflow Design boundary]
...
- Parent category: Prompt Engineering
- Parent topic: 091.02 Prompt and Workflow Design
