...
You own an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output. You must design, implement, test, operate, and explain Context Windows for a production system.
