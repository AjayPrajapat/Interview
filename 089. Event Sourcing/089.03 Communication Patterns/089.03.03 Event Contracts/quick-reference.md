...
Event Contracts is a Event Sourcing concept inside Communication Patterns that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
