# Domain-Specific Examples: Responsive Design

## Domain Lens

Category domain: frontend product engineering

Use Responsive Design to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
