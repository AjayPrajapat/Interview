# Code-Level Understanding: Responsive Design

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Responsive Design with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Responsive Design example.
