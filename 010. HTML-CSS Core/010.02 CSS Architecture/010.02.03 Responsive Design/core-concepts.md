...
Responsive Design is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside CSS Architecture.
...
Use Responsive Design to reason about:
