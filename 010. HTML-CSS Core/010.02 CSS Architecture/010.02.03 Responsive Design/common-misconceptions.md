# Common Misconceptions: Responsive Design
...
Write one sentence explaining what you used to believe about Responsive Design, then rewrite it with the production constraint included.
