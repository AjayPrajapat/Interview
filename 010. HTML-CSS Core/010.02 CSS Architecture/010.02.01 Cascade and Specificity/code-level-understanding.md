# Code-Level Understanding: Cascade and Specificity

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Cascade and Specificity with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Cascade and Specificity example.
