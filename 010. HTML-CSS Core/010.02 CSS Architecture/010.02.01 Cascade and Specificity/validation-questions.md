# Validation Questions: Cascade and Specificity

## Conceptual Questions

1. What problem does Cascade and Specificity solve in HTML/CSS Core?
...
1. A production issue appears only under high traffic. How would you investigate Cascade and Specificity?
...
2. What metric would move first if Cascade and Specificity became the bottleneck?

## Mastery Prompt

Explain Cascade and Specificity from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
