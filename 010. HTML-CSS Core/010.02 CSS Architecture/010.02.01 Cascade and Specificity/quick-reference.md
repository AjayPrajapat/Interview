# Quick Reference: Cascade and Specificity

## Core Definition

Cascade and Specificity is a HTML/CSS Core concept inside CSS Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Cascade and Specificity?
- Why does it matter in HTML/CSS Core?
