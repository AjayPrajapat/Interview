# Core Concepts: Cascade and Specificity

## Definition

Cascade and Specificity is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside CSS Architecture.
...
- It gives engineers a shared vocabulary for reasoning about CSS Architecture.
...
Use Cascade and Specificity to reason about:
...
- The CSS Architecture layer decides which path should execute.
