# Common Misconceptions: Layout Systems
...
Write one sentence explaining what you used to believe about Layout Systems, then rewrite it with the production constraint included.
