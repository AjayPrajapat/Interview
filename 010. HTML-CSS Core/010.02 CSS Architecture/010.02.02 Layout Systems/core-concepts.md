# Core Concepts: Layout Systems

## Definition

Layout Systems is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside CSS Architecture.
...
Use Layout Systems to reason about:
