# Core Concepts: Visual Stability

## Definition

Visual Stability is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside Rendering and Accessibility.
...
Use Visual Stability to reason about:
