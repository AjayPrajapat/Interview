# Code-Level Understanding: Visual Stability

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Visual Stability with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Visual Stability example.
