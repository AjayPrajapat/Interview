# Code-Level Understanding: Focus Management

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Focus Management with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Focus Management example.
