# Validation Questions: Accessible Names

## Conceptual Questions

1. What problem does Accessible Names solve in HTML/CSS Core?
...
1. A production issue appears only under high traffic. How would you investigate Accessible Names?
...
2. What metric would move first if Accessible Names became the bottleneck?

## Mastery Prompt

Explain Accessible Names from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
