# Code-Level Understanding: Accessible Names

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Accessible Names with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Accessible Names example.
