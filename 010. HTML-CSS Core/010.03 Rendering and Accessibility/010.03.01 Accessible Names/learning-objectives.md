# Learning Objectives: Accessible Names

## By The End, You Should Be Able To

- Define Accessible Names in the context of HTML/CSS Core without relying on memorized wording.
- Explain why Accessible Names belongs under Rendering and Accessibility and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Accessible Names.
