# Domain-Specific Examples: Accessible Names

## Domain Lens

Category domain: frontend product engineering

Use Accessible Names to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
