# Quick Reference: Accessible Names

## Core Definition

Accessible Names is a HTML/CSS Core concept inside Rendering and Accessibility that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
