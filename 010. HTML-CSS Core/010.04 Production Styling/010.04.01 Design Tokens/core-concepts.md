...
Design Tokens is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside Production Styling.
...
Use Design Tokens to reason about:
