# Code-Level Understanding: Design Tokens

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Design Tokens with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Design Tokens example.
