# Common Misconceptions: Design Tokens
...
Write one sentence explaining what you used to believe about Design Tokens, then rewrite it with the production constraint included.
