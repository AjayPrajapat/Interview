# Common Misconceptions: Maintainability
...
Write one sentence explaining what you used to believe about Maintainability, then rewrite it with the production constraint included.
