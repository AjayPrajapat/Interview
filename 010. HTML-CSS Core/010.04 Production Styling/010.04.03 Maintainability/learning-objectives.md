...
- Define Maintainability in the context of HTML/CSS Core without relying on memorized wording.
- Explain why Maintainability belongs under Production Styling and what dependency it creates for later topics.
