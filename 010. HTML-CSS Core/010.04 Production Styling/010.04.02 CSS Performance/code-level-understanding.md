# Code-Level Understanding: CSS Performance

## Example Exercise

Build a small HTML/CSS Core example that demonstrates CSS Performance with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete CSS Performance example.
