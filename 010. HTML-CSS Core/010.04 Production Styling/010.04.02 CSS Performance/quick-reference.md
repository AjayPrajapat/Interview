# Quick Reference: CSS Performance

## Core Definition

CSS Performance is a HTML/CSS Core concept inside Production Styling that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
