# Common Misconceptions: CSS Performance
...
Write one sentence explaining what you used to believe about CSS Performance, then rewrite it with the production constraint included.
