# Code-Level Understanding: Semantic Markup

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Semantic Markup with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Semantic Markup example.
