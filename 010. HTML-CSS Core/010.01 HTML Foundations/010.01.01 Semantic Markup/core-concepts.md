# Core Concepts: Semantic Markup

## Definition

Semantic Markup is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside HTML Foundations.
...
Use Semantic Markup to reason about:
