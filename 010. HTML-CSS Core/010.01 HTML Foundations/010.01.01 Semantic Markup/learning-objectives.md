# Learning Objectives: Semantic Markup

## By The End, You Should Be Able To

- Define Semantic Markup in the context of HTML/CSS Core without relying on memorized wording.
- Explain why Semantic Markup belongs under HTML Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Semantic Markup.
