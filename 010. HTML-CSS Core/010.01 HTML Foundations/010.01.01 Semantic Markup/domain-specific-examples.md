# Domain-Specific Examples: Semantic Markup

## Domain Lens

Category domain: frontend product engineering

Use Semantic Markup to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
