# Validation Questions: Semantic Markup

## Conceptual Questions

1. What problem does Semantic Markup solve in HTML/CSS Core?
...
1. A production issue appears only under high traffic. How would you investigate Semantic Markup?
...
2. What metric would move first if Semantic Markup became the bottleneck?

## Mastery Prompt

Explain Semantic Markup from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
