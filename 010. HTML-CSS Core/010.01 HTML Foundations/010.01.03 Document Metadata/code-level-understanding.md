# Code-Level Understanding: Document Metadata

## Example Exercise

Build a small HTML/CSS Core example that demonstrates Document Metadata with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Document Metadata example.
