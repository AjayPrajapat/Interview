# Core Concepts: Document Metadata

## Definition

Document Metadata is a core part of HTML/CSS Core that describes a specific behavior, boundary, or engineering decision inside HTML Foundations.
...
- It gives engineers a shared vocabulary for reasoning about HTML Foundations.
...
Use Document Metadata to reason about:
...
- The HTML Foundations layer decides which path should execute.
