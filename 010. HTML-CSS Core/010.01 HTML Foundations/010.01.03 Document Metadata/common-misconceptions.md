# Common Misconceptions: Document Metadata
...
Write one sentence explaining what you used to believe about Document Metadata, then rewrite it with the production constraint included.
