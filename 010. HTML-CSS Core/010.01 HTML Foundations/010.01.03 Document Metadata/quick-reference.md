# Quick Reference: Document Metadata

## Core Definition

Document Metadata is a HTML/CSS Core concept inside HTML Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
