# Hands-On Lab: Cost and Reliability Trade-offs

## Goal

Practice Cost and Reliability Trade-offs through a concrete quality and performance engineering exercise.

## Lab Task

write one fast test, one boundary test, one failure test, and one measurement experiment for this topic
