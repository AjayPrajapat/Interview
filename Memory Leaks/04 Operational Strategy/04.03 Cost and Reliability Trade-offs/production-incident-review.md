# Production Incident Review: Cost and Reliability Trade-offs

## Scenario

A change passes tests but fails under concurrency, large data, slow devices, or realistic production traffic.
