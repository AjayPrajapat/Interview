...
Use Operational Concerns to reason about a production workflow where correctness, observability, ownership, and maintainability matter.
...
In Code Quality, this example should translate into:
