# Common Misconceptions: Validation
...
Write one sentence explaining what you used to believe about Validation, then rewrite it with the production constraint included.
