# Common Misconceptions: Versioning
...
Write one sentence explaining what you used to believe about Versioning, then rewrite it with the production constraint included.
