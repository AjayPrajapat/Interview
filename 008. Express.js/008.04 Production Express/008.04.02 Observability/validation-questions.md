# Validation Questions: Observability

## Conceptual Questions

1. What problem does Observability solve in Express.js?
...
1. A production issue appears only under high traffic. How would you investigate Observability?
...
2. What metric would move first if Observability became the bottleneck?

## Mastery Prompt

Explain Observability from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
