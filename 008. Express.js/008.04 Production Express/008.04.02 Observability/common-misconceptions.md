# Common Misconceptions: Observability
...
Write one sentence explaining what you used to believe about Observability, then rewrite it with the production constraint included.
