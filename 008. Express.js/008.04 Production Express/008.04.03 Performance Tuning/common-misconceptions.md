# Common Misconceptions: Performance Tuning
...
Write one sentence explaining what you used to believe about Performance Tuning, then rewrite it with the production constraint included.
