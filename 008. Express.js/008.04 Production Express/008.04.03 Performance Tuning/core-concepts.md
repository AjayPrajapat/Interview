# Core Concepts: Performance Tuning

## Definition

Performance Tuning is a core part of Express.js that describes a specific behavior, boundary, or engineering decision inside Production Express.
...
- It gives engineers a shared vocabulary for reasoning about Production Express.
...
Use Performance Tuning to reason about:
...
- The Production Express layer decides which path should execute.
