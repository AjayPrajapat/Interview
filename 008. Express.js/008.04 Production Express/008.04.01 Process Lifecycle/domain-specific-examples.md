# Domain-Specific Examples: Process Lifecycle

## Domain Lens

Category domain: backend/API engineering

Use Process Lifecycle to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
