# Core Concepts: Process Lifecycle

## Definition

Process Lifecycle is a core part of Express.js that describes a specific behavior, boundary, or engineering decision inside Production Express.
...
Use Process Lifecycle to reason about:
