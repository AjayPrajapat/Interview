# Common Misconceptions: Process Lifecycle
...
Write one sentence explaining what you used to believe about Process Lifecycle, then rewrite it with the production constraint included.
