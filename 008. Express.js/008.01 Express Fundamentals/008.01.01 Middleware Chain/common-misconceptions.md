# Common Misconceptions: Middleware Chain
...
Write one sentence explaining what you used to believe about Middleware Chain, then rewrite it with the production constraint included.
