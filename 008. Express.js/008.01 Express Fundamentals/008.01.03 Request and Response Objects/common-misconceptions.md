# Common Misconceptions: Request and Response Objects
...
Write one sentence explaining what you used to believe about Request and Response Objects, then rewrite it with the production constraint included.
