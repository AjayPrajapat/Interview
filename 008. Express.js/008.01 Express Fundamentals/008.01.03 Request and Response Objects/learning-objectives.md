# Learning Objectives: Request and Response Objects

## By The End, You Should Be Able To

- Define Request and Response Objects in the context of Express.js without relying on memorized wording.
- Explain why Request and Response Objects belongs under Express Fundamentals and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Request and Response Objects.
