# Domain-Specific Examples: Routing

## Domain Lens

Category domain: backend/API engineering

Use Routing to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
