# Common Misconceptions: Rate Limiting
...
Write one sentence explaining what you used to believe about Rate Limiting, then rewrite it with the production constraint included.
