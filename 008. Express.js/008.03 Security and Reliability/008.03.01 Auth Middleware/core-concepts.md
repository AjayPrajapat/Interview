# Core Concepts: Auth Middleware

## Definition

Auth Middleware is a core part of Express.js that describes a specific behavior, boundary, or engineering decision inside Security and Reliability.
...
Use Auth Middleware to reason about:
