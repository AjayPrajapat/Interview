# Common Misconceptions: Auth Middleware
...
Write one sentence explaining what you used to believe about Auth Middleware, then rewrite it with the production constraint included.
