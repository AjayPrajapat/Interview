# Compare And Contrast: Input Sanitization
...
For Input Sanitization, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
