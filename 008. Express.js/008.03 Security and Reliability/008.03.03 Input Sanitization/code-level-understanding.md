# Code-Level Understanding: Input Sanitization

## Example Exercise

Build a small Express.js example that demonstrates Input Sanitization with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Input Sanitization example.
