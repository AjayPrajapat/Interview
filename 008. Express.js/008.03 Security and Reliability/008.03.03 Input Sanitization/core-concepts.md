# Core Concepts: Input Sanitization

## Definition

Input Sanitization is a core part of Express.js that describes a specific behavior, boundary, or engineering decision inside Security and Reliability.
...
- It gives engineers a shared vocabulary for reasoning about Security and Reliability.
...
Use Input Sanitization to reason about:
...
- The Security and Reliability layer decides which path should execute.
