# Common Misconceptions: Input Sanitization
...
Write one sentence explaining what you used to believe about Input Sanitization, then rewrite it with the production constraint included.
