# Domain-Specific Examples: Migrations

## Domain Lens

Category domain: data and persistence engineering

Use Migrations to reason about a high-traffic data access path where schema shape, indexes, transactions, and access patterns determine correctness and latency.
