# Validation Questions: Replication

## Conceptual Questions

1. What problem does Replication solve in Indexing & Query Optimization?
...
1. A production issue appears only under high traffic. How would you investigate Replication?
...
2. What metric would move first if Replication became the bottleneck?

## Mastery Prompt

Explain Replication from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
