# Core Concepts: Replication

## Definition

Replication is a core part of Indexing & Query Optimization that describes a specific behavior, boundary, or engineering decision inside Distributed Data.
...
Use Replication to reason about:
