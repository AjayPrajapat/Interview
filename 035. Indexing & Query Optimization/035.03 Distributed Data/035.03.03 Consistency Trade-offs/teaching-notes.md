# Teaching Notes: Consistency Trade-offs

## Teach To A Beginner

Start with the problem Consistency Trade-offs solves. Avoid jargon until the learner can explain the basic behavior.
