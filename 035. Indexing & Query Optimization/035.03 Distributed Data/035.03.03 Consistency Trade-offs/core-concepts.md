# Core Concepts: Consistency Trade-offs

## Definition

Consistency Trade-offs is a core part of Indexing & Query Optimization that describes a specific behavior, boundary, or engineering decision inside Distributed Data.
...
- It gives engineers a shared vocabulary for reasoning about Distributed Data.
...
Use Consistency Trade-offs to reason about:
...
- The Distributed Data layer decides which path should execute.
