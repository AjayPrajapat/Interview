# Diagrams: 035.03.02 Sharding

Category: Indexing & Query Optimization

Topic: 035.03 Distributed Data

Use these diagrams to understand Sharding visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
Do not optimize Sharding by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Sharding"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Sharding"] --> B{"Clear Owner?"}
