# Validation Questions: Sharding

## Conceptual Questions

1. What problem does Sharding solve in Indexing & Query Optimization?
...
1. A production issue appears only under high traffic. How would you investigate Sharding?
...
2. What metric would move first if Sharding became the bottleneck?

## Mastery Prompt

Explain Sharding from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
