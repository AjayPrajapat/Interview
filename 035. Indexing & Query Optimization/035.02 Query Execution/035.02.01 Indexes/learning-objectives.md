# Learning Objectives: Indexes

## By The End, You Should Be Able To

- Define Indexes in the context of Indexing & Query Optimization without relying on memorized wording.
- Explain why Indexes belongs under Query Execution and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Indexes.
