# Core Concepts: Indexes

## Definition

Indexes is a core part of Indexing & Query Optimization that describes a specific behavior, boundary, or engineering decision inside Query Execution.
