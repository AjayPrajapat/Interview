# Core Concepts: Locking and Isolation

## Definition

Locking and Isolation is a core part of Indexing & Query Optimization that describes a specific behavior, boundary, or engineering decision inside Query Execution.
...
- It gives engineers a shared vocabulary for reasoning about Query Execution.
...
Use Locking and Isolation to reason about:
...
- The Query Execution layer decides which path should execute.
