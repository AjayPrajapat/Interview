# Quick Reference: Query Plans

## Core Definition

Query Plans is a Indexing & Query Optimization concept inside Query Execution that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
