# Core Concepts: Query Plans

## Definition

Query Plans is a core part of Indexing & Query Optimization that describes a specific behavior, boundary, or engineering decision inside Query Execution.
...
Use Query Plans to reason about:
