# Common Misconceptions: Query Plans
...
Write one sentence explaining what you used to believe about Query Plans, then rewrite it with the production constraint included.
