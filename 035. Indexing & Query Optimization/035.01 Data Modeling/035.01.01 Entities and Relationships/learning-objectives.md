# Learning Objectives: Entities and Relationships

## By The End, You Should Be Able To

- Define Entities and Relationships in the context of Indexing & Query Optimization without relying on memorized wording.
- Explain why Entities and Relationships belongs under Data Modeling and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Entities and Relationships.
