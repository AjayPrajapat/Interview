# Domain-Specific Examples: Entities and Relationships

## Domain Lens

Category domain: data and persistence engineering

Use Entities and Relationships to reason about a high-traffic data access path where schema shape, indexes, transactions, and access patterns determine correctness and latency.
