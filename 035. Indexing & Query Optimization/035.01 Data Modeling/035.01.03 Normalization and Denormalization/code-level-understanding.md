# Code-Level Understanding: Normalization and Denormalization

## Example Exercise

Build a small Indexing & Query Optimization example that demonstrates Normalization and Denormalization with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Normalization and Denormalization example.
