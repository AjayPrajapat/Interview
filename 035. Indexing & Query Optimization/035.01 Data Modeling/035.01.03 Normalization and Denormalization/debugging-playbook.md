# Debugging Playbook: Normalization and Denormalization

## Start Here

Debug Normalization and Denormalization by moving from symptom to invariant, not from stack trace to guess.
