# Domain-Specific Examples: Normalization and Denormalization

## Domain Lens

Category domain: data and persistence engineering

Use Normalization and Denormalization to reason about a high-traffic data access path where schema shape, indexes, transactions, and access patterns determine correctness and latency.
...
In Indexing & Query Optimization, this example should translate into:
