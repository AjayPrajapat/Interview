# Learning Objectives: Normalization and Denormalization

## By The End, You Should Be Able To

- Define Normalization and Denormalization in the context of Indexing & Query Optimization without relying on memorized wording.
- Explain why Normalization and Denormalization belongs under Data Modeling and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Normalization and Denormalization.
