# Core Concepts: Refactoring Safety

## Definition

Refactoring Safety is a core part of Functional Programming that describes a specific behavior, boundary, or engineering decision inside Production Design.
...
- It gives engineers a shared vocabulary for reasoning about Production Design.
...
Use Refactoring Safety to reason about:
...
- The Production Design layer decides which path should execute.
