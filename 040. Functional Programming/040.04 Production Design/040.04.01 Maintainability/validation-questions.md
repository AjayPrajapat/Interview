# Validation Questions: Maintainability

## Conceptual Questions

1. What problem does Maintainability solve in Functional Programming?
...
1. A production issue appears only under high traffic. How would you investigate Maintainability?
...
2. What metric would move first if Maintainability became the bottleneck?

## Mastery Prompt

Explain Maintainability from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
