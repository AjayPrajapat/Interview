# Code-Level Understanding: Extensibility

## Example Exercise

Build a small Functional Programming example that demonstrates Extensibility with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Extensibility example.
