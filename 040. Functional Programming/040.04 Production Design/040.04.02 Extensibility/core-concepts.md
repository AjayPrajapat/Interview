# Core Concepts: Extensibility

## Definition

Extensibility is a core part of Functional Programming that describes a specific behavior, boundary, or engineering decision inside Production Design.
...
Use Extensibility to reason about:
