...
- Define Modeling in the context of Functional Programming without relying on memorized wording.
- Explain why Modeling belongs under Design Techniques and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Modeling.
