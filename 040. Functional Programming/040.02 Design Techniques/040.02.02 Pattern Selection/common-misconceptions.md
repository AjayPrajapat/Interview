# Common Misconceptions: Pattern Selection
...
Write one sentence explaining what you used to believe about Pattern Selection, then rewrite it with the production constraint included.
