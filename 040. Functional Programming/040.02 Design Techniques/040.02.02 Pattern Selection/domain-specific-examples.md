# Domain-Specific Examples: Pattern Selection

## Domain Lens

Category domain: language/runtime engineering

Use Pattern Selection to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
