# Core Concepts: Pattern Selection

## Definition

Pattern Selection is a core part of Functional Programming that describes a specific behavior, boundary, or engineering decision inside Design Techniques.
...
Use Pattern Selection to reason about:
