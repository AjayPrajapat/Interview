# Code-Level Understanding: Pattern Selection

## Example Exercise

Build a small Functional Programming example that demonstrates Pattern Selection with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Pattern Selection example.
