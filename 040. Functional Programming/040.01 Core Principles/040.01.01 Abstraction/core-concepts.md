...
Abstraction is a core part of Functional Programming that describes a specific behavior, boundary, or engineering decision inside Core Principles.
...
Use Abstraction to reason about:
