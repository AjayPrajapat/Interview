# Validation Questions: Abstraction

## Conceptual Questions

1. What problem does Abstraction solve in Functional Programming?
...
1. A production issue appears only under high traffic. How would you investigate Abstraction?
...
2. What metric would move first if Abstraction became the bottleneck?

## Mastery Prompt

Explain Abstraction from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
