# Common Misconceptions: Abstraction
...
Write one sentence explaining what you used to believe about Abstraction, then rewrite it with the production constraint included.
