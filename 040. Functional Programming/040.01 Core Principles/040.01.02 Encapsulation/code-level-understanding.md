# Code-Level Understanding: Encapsulation

## Example Exercise

Build a small Functional Programming example that demonstrates Encapsulation with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Encapsulation example.
