# Common Misconceptions: Encapsulation
...
Write one sentence explaining what you used to believe about Encapsulation, then rewrite it with the production constraint included.
