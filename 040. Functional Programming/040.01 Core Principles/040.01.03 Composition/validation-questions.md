# Validation Questions: Composition

## Conceptual Questions

1. What problem does Composition solve in Functional Programming?
...
1. A production issue appears only under high traffic. How would you investigate Composition?
...
2. What metric would move first if Composition became the bottleneck?

## Mastery Prompt

Explain Composition from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
