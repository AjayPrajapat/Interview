# Code-Level Understanding: Composition

## Example Exercise

Build a small Functional Programming example that demonstrates Composition with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Composition example.
