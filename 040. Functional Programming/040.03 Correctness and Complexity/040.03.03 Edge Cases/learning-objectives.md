...
- Define Edge Cases in the context of Functional Programming without relying on memorized wording.
- Explain why Edge Cases belongs under Correctness and Complexity and what dependency it creates for later topics.
