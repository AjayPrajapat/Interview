# Learning Objectives: Time and Space Complexity

## By The End, You Should Be Able To

- Define Time and Space Complexity in the context of Functional Programming without relying on memorized wording.
- Explain why Time and Space Complexity belongs under Correctness and Complexity and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Time and Space Complexity.
