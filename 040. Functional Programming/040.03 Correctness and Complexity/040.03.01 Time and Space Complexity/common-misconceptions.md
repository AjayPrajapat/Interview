# Common Misconceptions: Time and Space Complexity
...
Write one sentence explaining what you used to believe about Time and Space Complexity, then rewrite it with the production constraint included.
