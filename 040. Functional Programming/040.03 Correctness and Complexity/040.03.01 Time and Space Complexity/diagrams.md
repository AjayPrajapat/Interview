# Diagrams: 040.03.01 Time and Space Complexity
...
```mermaid
flowchart TD
  A["Functional Programming"] --> B["040.03 Correctness and Complexity"]
...
For Functional Programming, pay special attention to:

- runtime errors, latency, memory growth, bundle size, CPU time, test failures, and defect rate,
