# Common Misconceptions: Decision Making
...
Write one sentence explaining what you used to believe about Decision Making, then rewrite it with the production constraint included.
