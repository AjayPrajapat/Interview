# Common Misconceptions: CI Integration
...
Write one sentence explaining what you used to believe about CI Integration, then rewrite it with the production constraint included.
