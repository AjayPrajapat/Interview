# Common Misconceptions: Regression Detection
...
Write one sentence explaining what you used to believe about Regression Detection, then rewrite it with the production constraint included.
