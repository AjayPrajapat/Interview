...
Requirements and Constraints is a BFF Pattern topic that must be understood through definition, internal flow, failure behavior, production usage, and trade-offs.
