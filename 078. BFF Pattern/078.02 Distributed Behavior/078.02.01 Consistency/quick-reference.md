...
Consistency is a BFF Pattern concept inside Distributed Behavior that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
