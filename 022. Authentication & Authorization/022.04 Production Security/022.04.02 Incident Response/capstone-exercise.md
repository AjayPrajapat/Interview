# Capstone Exercise: Incident Response

## Scenario

You own a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract. You must design, implement, test, operate, and explain Incident Response for a production system.
