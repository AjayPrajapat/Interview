# Common Misconceptions: Incident Response
...
Write one sentence explaining what you used to believe about Incident Response, then rewrite it with the production constraint included.
