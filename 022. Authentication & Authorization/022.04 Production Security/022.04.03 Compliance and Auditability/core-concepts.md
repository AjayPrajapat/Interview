...
Compliance and Auditability is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Production Security.
...
- It gives engineers a shared vocabulary for reasoning about Production Security.
...
Use Compliance and Auditability to reason about:
