# Quick Reference: Compliance and Auditability

## Core Definition

Compliance and Auditability is a Authentication & Authorization concept inside Production Security that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Compliance and Auditability?
- Why does it matter in Authentication & Authorization?
