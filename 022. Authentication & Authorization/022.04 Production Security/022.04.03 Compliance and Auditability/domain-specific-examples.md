# Domain-Specific Examples: Compliance and Auditability

## Domain Lens

Category domain: backend/API engineering

Use Compliance and Auditability to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
...
In Authentication & Authorization, this example should translate into:
