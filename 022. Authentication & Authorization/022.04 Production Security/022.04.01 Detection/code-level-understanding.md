# Code-Level Understanding: Detection

## Example Exercise

Build a small Authentication & Authorization example that demonstrates Detection with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Detection example.
