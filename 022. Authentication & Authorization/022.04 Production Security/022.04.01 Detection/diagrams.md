# Diagrams: 022.04.01 Detection

Category: Authentication & Authorization

Topic: 022.04 Production Security

Use these diagrams to understand Detection visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
Do not optimize Detection by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Detection"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Detection"] --> B{"Clear Owner?"}
