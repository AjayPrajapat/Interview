# Core Concepts: Detection

## Definition

Detection is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Production Security.
