...
Input Validation is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Application Security.
...
Use Input Validation to reason about:
