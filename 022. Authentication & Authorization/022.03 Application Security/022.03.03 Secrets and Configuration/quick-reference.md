# Quick Reference: Secrets and Configuration

## Core Definition

Secrets and Configuration is a Authentication & Authorization concept inside Application Security that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Secrets and Configuration?
