# Core Concepts: Secrets and Configuration

## Definition

Secrets and Configuration is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Application Security.
...
- It gives engineers a shared vocabulary for reasoning about Application Security.
...
Use Secrets and Configuration to reason about:
