# Quick Reference: Injection and XSS

## Core Definition

Injection and XSS is a Authentication & Authorization concept inside Application Security that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
