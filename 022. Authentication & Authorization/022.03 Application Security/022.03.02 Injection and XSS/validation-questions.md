# Validation Questions: Injection and XSS

## Conceptual Questions

1. What problem does Injection and XSS solve in Authentication & Authorization?
...
1. A production issue appears only under high traffic. How would you investigate Injection and XSS?
...
2. What metric would move first if Injection and XSS became the bottleneck?

## Mastery Prompt

Explain Injection and XSS from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
