# Domain-Specific Examples: Injection and XSS

## Domain Lens

Category domain: backend/API engineering

Use Injection and XSS to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
