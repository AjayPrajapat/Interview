...
Injection and XSS is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Application Security.
...
Use Injection and XSS to reason about:
