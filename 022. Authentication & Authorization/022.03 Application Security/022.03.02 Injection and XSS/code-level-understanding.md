...
Build a small Authentication & Authorization example that demonstrates Injection and XSS with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Injection and XSS example.
