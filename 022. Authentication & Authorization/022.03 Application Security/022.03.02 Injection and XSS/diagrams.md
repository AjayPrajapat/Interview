# Diagrams: 022.03.02 Injection and XSS

Category: Authentication & Authorization

Topic: 022.03 Application Security

Use these diagrams to understand Injection and XSS visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Injection and XSS Rules"]
...
sequenceDiagram
  ...
  participant Core as Injection and XSS
  participant State
...
Do not optimize Injection and XSS by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Injection and XSS"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Injection and XSS"] --> B{"Clear Owner?"}
...
```text
[ ] I can define Injection and XSS.
