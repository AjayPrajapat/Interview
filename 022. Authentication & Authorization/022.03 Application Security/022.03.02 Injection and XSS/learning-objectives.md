# Learning Objectives: Injection and XSS

## By The End, You Should Be Able To

- Define Injection and XSS in the context of Authentication & Authorization without relying on memorized wording.
- Explain why Injection and XSS belongs under Application Security and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Injection and XSS.
