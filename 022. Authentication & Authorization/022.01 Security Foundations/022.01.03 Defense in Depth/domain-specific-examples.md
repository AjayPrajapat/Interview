# Domain-Specific Examples: Defense in Depth

## Domain Lens

Category domain: backend/API engineering

Use Defense in Depth to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
