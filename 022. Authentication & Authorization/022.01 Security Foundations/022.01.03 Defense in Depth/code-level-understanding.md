# Code-Level Understanding: Defense in Depth

## Example Exercise

Build a small Authentication & Authorization example that demonstrates Defense in Depth with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Defense in Depth example.
