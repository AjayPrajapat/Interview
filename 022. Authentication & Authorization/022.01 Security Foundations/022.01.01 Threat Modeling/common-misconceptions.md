# Common Misconceptions: Threat Modeling
...
Write one sentence explaining what you used to believe about Threat Modeling, then rewrite it with the production constraint included.
