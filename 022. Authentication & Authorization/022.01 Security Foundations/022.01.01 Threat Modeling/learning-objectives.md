...
- Define Threat Modeling in the context of Authentication & Authorization without relying on memorized wording.
- Explain why Threat Modeling belongs under Security Foundations and what dependency it creates for later topics.
