...
Trust Boundaries is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Security Foundations.
...
Use Trust Boundaries to reason about:
