# Teaching Notes: Session and Token Security

## Teach To A Beginner

Start with the problem Session and Token Security solves. Avoid jargon until the learner can explain the basic behavior.
