# Quick Reference: Session and Token Security

## Core Definition

Session and Token Security is a Authentication & Authorization concept inside Identity and Access that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Session and Token Security?
