# Common Misconceptions: Authentication Flows
...
Write one sentence explaining what you used to believe about Authentication Flows, then rewrite it with the production constraint included.
