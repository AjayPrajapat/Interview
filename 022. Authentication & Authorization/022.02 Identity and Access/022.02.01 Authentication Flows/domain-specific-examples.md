# Domain-Specific Examples: Authentication Flows

## Domain Lens

Category domain: backend/API engineering

Use Authentication Flows to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
