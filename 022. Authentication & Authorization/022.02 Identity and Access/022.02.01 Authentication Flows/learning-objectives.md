# Learning Objectives: Authentication Flows

## By The End, You Should Be Able To

- Define Authentication Flows in the context of Authentication & Authorization without relying on memorized wording.
- Explain why Authentication Flows belongs under Identity and Access and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Authentication Flows.
