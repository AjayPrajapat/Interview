...
Authorization Models is a core part of Authentication & Authorization that describes a specific behavior, boundary, or engineering decision inside Identity and Access.
...
Use Authorization Models to reason about:
