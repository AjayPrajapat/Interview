# Learning Objectives: Authorization Models

## By The End, You Should Be Able To

- Define Authorization Models in the context of Authentication & Authorization without relying on memorized wording.
- Explain why Authorization Models belongs under Identity and Access and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Authorization Models.
