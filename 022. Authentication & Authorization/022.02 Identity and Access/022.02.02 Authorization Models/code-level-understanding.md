# Code-Level Understanding: Authorization Models

## Example Exercise

Build a small Authentication & Authorization example that demonstrates Authorization Models with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Authorization Models example.
