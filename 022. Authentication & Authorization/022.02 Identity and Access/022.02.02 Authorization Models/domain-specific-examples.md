# Domain-Specific Examples: Authorization Models

## Domain Lens

Category domain: backend/API engineering

Use Authorization Models to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
