# Quick Reference: Authorization Models

## Core Definition

Authorization Models is a Authentication & Authorization concept inside Identity and Access that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
