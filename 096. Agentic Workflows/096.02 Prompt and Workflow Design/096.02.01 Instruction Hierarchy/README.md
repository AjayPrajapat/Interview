...
Topic: 096.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 096.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Agentic Workflows.
...
- reduce ambiguity in 096.02 Prompt and Workflow Design,
...
In Agentic Workflows, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 096.02 Prompt and Workflow Design boundary
...
For Agentic Workflows, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere Agentic Workflows needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in Agentic Workflows?
2. What problem does it solve inside 096.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 096.02 Prompt and Workflow Design boundary]
...
- Parent category: Agentic Workflows
- Parent topic: 096.02 Prompt and Workflow Design
