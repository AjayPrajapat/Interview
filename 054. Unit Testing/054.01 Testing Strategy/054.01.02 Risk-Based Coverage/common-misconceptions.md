# Common Misconceptions: Risk-Based Coverage
...
Write one sentence explaining what you used to believe about Risk-Based Coverage, then rewrite it with the production constraint included.
