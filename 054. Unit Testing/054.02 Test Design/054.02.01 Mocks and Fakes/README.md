# 054.02.01 Mocks and Fakes

Category: Unit Testing

Topic: 054.02 Test Design

## 1. Definition

Mocks and Fakes is a focused engineering concept inside 054.02 Test Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Unit Testing.
...
- reduce ambiguity in 054.02 Test Design,
...
In Unit Testing, Mocks and Fakes commonly appears as a test case, fixture, contract, test double, assertion, load profile, or quality gate.
...
Input / trigger
  ...
  -> enter 054.02 Test Design boundary
...
Mocks and Fakes appears in production anywhere Unit Testing needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Mocks and Fakes, and why does it matter in Unit Testing?
2. What problem does it solve inside 054.02 Test Design?
...
flowchart TD
  ...
  B --> C[Enter 054.02 Test Design boundary]
...
- Parent topic: 054.02 Test Design
