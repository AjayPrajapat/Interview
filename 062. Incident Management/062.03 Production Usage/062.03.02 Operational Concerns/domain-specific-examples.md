...
Use Operational Concerns to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
...
In Incident Management, this example should translate into:
