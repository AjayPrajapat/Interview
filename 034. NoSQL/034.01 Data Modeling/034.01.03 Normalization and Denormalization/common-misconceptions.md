# Common Misconceptions: Normalization and Denormalization

## Misconception 1

Database design is only schema design. Production data work includes access patterns, locking, migrations, consistency, backups, and query plans.
...
Write one sentence explaining what you used to believe about Normalization and Denormalization, then rewrite it with the production constraint included.
