...
Normalization and Denormalization is a NoSQL concept inside Data Modeling that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
