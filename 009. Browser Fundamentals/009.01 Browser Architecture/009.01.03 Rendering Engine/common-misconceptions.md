# Common Misconceptions: Rendering Engine
...
Write one sentence explaining what you used to believe about Rendering Engine, then rewrite it with the production constraint included.
