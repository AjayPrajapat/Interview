# Core Concepts: Rendering Engine

## Definition

Rendering Engine is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Browser Architecture.
...
Use Rendering Engine to reason about:
