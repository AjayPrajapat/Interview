# Learning Objectives: Processes and Threads

## By The End, You Should Be Able To

- Define Processes and Threads in the context of Browser Fundamentals without relying on memorized wording.
- Explain why Processes and Threads belongs under Browser Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Processes and Threads.
