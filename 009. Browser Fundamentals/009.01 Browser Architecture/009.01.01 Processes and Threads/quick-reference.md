# Quick Reference: Processes and Threads

## Core Definition

Processes and Threads is a Browser Fundamentals concept inside Browser Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Processes and Threads?
- Why does it matter in Browser Fundamentals?
