# Domain-Specific Examples: Navigation Pipeline

## Domain Lens

Category domain: frontend product engineering

Use Navigation Pipeline to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
