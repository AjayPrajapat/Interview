# Common Misconceptions: Navigation Pipeline
...
Write one sentence explaining what you used to believe about Navigation Pipeline, then rewrite it with the production constraint included.
