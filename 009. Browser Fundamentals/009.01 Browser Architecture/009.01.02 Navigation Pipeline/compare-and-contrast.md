# Compare And Contrast: Navigation Pipeline
...
For Navigation Pipeline, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
