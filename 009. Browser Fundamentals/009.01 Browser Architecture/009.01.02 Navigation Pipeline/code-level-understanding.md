# Code-Level Understanding: Navigation Pipeline

## Example Exercise

Build a small Browser Fundamentals example that demonstrates Navigation Pipeline with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Navigation Pipeline example.
