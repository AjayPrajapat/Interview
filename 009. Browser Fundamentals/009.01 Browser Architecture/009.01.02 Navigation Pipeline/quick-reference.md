# Quick Reference: Navigation Pipeline

## Core Definition

Navigation Pipeline is a Browser Fundamentals concept inside Browser Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
