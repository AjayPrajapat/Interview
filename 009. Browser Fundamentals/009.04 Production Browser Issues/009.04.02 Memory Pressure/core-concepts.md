# Core Concepts: Memory Pressure

## Definition

Memory Pressure is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Production Browser Issues.
...
Use Memory Pressure to reason about:
