# Common Misconceptions: Memory Pressure
...
Write one sentence explaining what you used to believe about Memory Pressure, then rewrite it with the production constraint included.
