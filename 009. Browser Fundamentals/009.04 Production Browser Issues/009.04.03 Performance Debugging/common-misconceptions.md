# Common Misconceptions: Performance Debugging
...
Write one sentence explaining what you used to believe about Performance Debugging, then rewrite it with the production constraint included.
