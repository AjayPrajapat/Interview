# Core Concepts: Performance Debugging

## Definition

Performance Debugging is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Production Browser Issues.
...
- It gives engineers a shared vocabulary for reasoning about Production Browser Issues.
...
Use Performance Debugging to reason about:
...
- The Production Browser Issues layer decides which path should execute.
