# Common Misconceptions: Compatibility
...
Write one sentence explaining what you used to believe about Compatibility, then rewrite it with the production constraint included.
