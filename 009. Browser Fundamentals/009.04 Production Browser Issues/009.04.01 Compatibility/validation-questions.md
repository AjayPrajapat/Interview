# Validation Questions: Compatibility

## Conceptual Questions

1. What problem does Compatibility solve in Browser Fundamentals?
...
1. A production issue appears only under high traffic. How would you investigate Compatibility?
...
2. What metric would move first if Compatibility became the bottleneck?

## Mastery Prompt

Explain Compatibility from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
