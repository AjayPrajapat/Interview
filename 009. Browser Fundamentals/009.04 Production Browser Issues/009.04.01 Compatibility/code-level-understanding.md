# Code-Level Understanding: Compatibility

## Example Exercise

Build a small Browser Fundamentals example that demonstrates Compatibility with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Compatibility example.
