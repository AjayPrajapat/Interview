# Code-Level Understanding: Compositing

## Example Exercise

Build a small Browser Fundamentals example that demonstrates Compositing with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Compositing example.
