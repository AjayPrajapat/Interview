# Validation Questions: Compositing

## Conceptual Questions

1. What problem does Compositing solve in Browser Fundamentals?
...
1. A production issue appears only under high traffic. How would you investigate Compositing?
...
2. What metric would move first if Compositing became the bottleneck?

## Mastery Prompt

Explain Compositing from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
