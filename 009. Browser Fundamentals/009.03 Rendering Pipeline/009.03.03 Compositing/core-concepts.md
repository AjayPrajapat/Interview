# Core Concepts: Compositing

## Definition

Compositing is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Rendering Pipeline.
...
Use Compositing to reason about:
