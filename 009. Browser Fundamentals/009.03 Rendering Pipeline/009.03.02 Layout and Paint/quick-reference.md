# Quick Reference: Layout and Paint

## Core Definition

Layout and Paint is a Browser Fundamentals concept inside Rendering Pipeline that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
