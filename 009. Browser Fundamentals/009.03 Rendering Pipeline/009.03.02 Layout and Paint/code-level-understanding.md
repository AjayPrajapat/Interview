# Code-Level Understanding: Layout and Paint

## Example Exercise

Build a small Browser Fundamentals example that demonstrates Layout and Paint with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Layout and Paint example.
