# Domain-Specific Examples: Layout and Paint

## Domain Lens

Category domain: frontend product engineering

Use Layout and Paint to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
