# Core Concepts: Layout and Paint

## Definition

Layout and Paint is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Rendering Pipeline.
...
Use Layout and Paint to reason about:
