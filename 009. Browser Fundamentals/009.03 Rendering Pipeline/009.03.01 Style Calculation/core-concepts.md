# Core Concepts: Style Calculation

## Definition

Style Calculation is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Rendering Pipeline.
...
- It gives engineers a shared vocabulary for reasoning about Rendering Pipeline.
...
Use Style Calculation to reason about:
...
- The Rendering Pipeline layer decides which path should execute.
