# Common Misconceptions: DOM and Events
...
Write one sentence explaining what you used to believe about DOM and Events, then rewrite it with the production constraint included.
