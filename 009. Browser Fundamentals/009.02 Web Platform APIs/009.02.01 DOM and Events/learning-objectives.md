# Learning Objectives: DOM and Events

## By The End, You Should Be Able To

- Define DOM and Events in the context of Browser Fundamentals without relying on memorized wording.
- Explain why DOM and Events belongs under Web Platform APIs and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to DOM and Events.
