# Core Concepts: DOM and Events

## Definition

DOM and Events is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Web Platform APIs.
...
- It gives engineers a shared vocabulary for reasoning about Web Platform APIs.
...
Use DOM and Events to reason about:
...
- The Web Platform APIs layer decides which path should execute.
