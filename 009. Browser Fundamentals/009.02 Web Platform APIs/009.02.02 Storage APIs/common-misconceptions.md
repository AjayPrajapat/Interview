# Common Misconceptions: Storage APIs
...
Write one sentence explaining what you used to believe about Storage APIs, then rewrite it with the production constraint included.
