# Core Concepts: Storage APIs

## Definition

Storage APIs is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Web Platform APIs.
...
Use Storage APIs to reason about:
