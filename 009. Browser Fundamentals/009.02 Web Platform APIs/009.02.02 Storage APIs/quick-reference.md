# Quick Reference: Storage APIs

## Core Definition

Storage APIs is a Browser Fundamentals concept inside Web Platform APIs that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
