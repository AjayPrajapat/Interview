# Core Concepts: Network APIs

## Definition

Network APIs is a core part of Browser Fundamentals that describes a specific behavior, boundary, or engineering decision inside Web Platform APIs.
...
Use Network APIs to reason about:
