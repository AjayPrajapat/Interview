# Learning Objectives: Network APIs

## By The End, You Should Be Able To

- Define Network APIs in the context of Browser Fundamentals without relying on memorized wording.
- Explain why Network APIs belongs under Web Platform APIs and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Network APIs.
