# Common Misconceptions: Network APIs
...
Write one sentence explaining what you used to believe about Network APIs, then rewrite it with the production constraint included.
