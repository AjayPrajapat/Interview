# Code-Level Understanding: Network APIs

## Example Exercise

Build a small Browser Fundamentals example that demonstrates Network APIs with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Network APIs example.
