# Capstone Exercise: Capacity Limits

## Scenario

You own a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions. You must design, implement, test, operate, and explain Capacity Limits for a production system.
