...
Decision Making is a focused engineering concept inside 102.01 Technical Leadership. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Estimation & Planning.
...
In Estimation & Planning, Decision Making commonly appears as a module, workflow, decision, service, contract, or operational process.
...
Decision Making appears in production anywhere Estimation & Planning needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Decision Making, and why does it matter in Estimation & Planning?
