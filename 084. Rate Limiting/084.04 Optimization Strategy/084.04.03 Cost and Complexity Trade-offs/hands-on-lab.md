...
Practice Cost and Complexity Trade-offs through a concrete distributed systems architecture exercise.

## Lab Task

model a workflow with one synchronous call, one async message, one retry, and one compensation path
