# Common Misconceptions: Cost and Complexity Trade-offs

## Misconception 1

More services automatically improve scale. Distributed design trades local simplicity for coordination, consistency, observability, and failure complexity.
...
Write one sentence explaining what you used to believe about Cost and Complexity Trade-offs, then rewrite it with the production constraint included.
