...
Backpressure is a focused engineering concept inside 084.02 Runtime Behavior. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Rate Limiting.
...
In Rate Limiting, Backpressure commonly appears as a module, workflow, decision, service, contract, or operational process.
...
Backpressure appears in production anywhere Rate Limiting needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Backpressure, and why does it matter in Rate Limiting?
