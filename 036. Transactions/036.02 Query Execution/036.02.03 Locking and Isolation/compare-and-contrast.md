# Compare And Contrast: Locking and Isolation
...
For Locking and Isolation, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
