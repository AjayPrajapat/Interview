...
Replication is a focused engineering concept inside 036.03 Distributed Data. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Transactions.
...
In Transactions, Replication commonly appears as a schema, query, transaction, index, cache key, document, table, or consistency boundary.
...
Replication appears in production anywhere Transactions needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Replication, and why does it matter in Transactions?
