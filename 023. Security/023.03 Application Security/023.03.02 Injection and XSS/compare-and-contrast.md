# Compare And Contrast: Injection and XSS
...
For Injection and XSS, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
