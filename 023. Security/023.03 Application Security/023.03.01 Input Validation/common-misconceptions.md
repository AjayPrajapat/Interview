# Common Misconceptions: Input Validation
...
Write one sentence explaining what you used to believe about Input Validation, then rewrite it with the production constraint included.
