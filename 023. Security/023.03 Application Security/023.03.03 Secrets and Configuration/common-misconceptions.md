# Common Misconceptions: Secrets and Configuration
...
Write one sentence explaining what you used to believe about Secrets and Configuration, then rewrite it with the production constraint included.
