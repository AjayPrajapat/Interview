...
Detection is a Security concept inside Production Security that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
