...
You own a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align. You must design, implement, test, operate, and explain Detection for a production system.
