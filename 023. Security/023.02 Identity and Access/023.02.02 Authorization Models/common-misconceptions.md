# Common Misconceptions: Authorization Models
...
Write one sentence explaining what you used to believe about Authorization Models, then rewrite it with the production constraint included.
