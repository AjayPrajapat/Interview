# Validation Questions: Flaky Test Control

## Conceptual Questions

1. What problem does Flaky Test Control solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Flaky Test Control?
...
2. What metric would move first if Flaky Test Control became the bottleneck?

## Mastery Prompt

Explain Flaky Test Control from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
