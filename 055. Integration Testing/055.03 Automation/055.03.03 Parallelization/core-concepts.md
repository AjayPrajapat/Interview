# Core Concepts: Parallelization

## Definition

Parallelization is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Automation.
...
Use Parallelization to reason about:
