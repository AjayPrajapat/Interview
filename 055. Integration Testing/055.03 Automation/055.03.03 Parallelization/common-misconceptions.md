# Common Misconceptions: Parallelization
...
Write one sentence explaining what you used to believe about Parallelization, then rewrite it with the production constraint included.
