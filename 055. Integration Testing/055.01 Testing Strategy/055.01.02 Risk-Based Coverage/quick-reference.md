# Quick Reference: Risk-Based Coverage

## Core Definition

Risk-Based Coverage is a Integration Testing concept inside Testing Strategy that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Risk-Based Coverage?
- Why does it matter in Integration Testing?
