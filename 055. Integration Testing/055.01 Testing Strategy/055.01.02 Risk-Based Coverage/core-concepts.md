# Core Concepts: Risk-Based Coverage

## Definition

Risk-Based Coverage is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Testing Strategy.
...
- It gives engineers a shared vocabulary for reasoning about Testing Strategy.
...
Use Risk-Based Coverage to reason about:
...
- The Testing Strategy layer decides which path should execute.
