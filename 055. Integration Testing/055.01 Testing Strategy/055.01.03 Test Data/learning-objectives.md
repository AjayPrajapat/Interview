...
- Define Test Data in the context of Integration Testing without relying on memorized wording.
- Explain why Test Data belongs under Testing Strategy and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Test Data.
