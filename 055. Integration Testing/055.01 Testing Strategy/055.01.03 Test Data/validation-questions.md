# Validation Questions: Test Data

## Conceptual Questions

1. What problem does Test Data solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Test Data?
...
2. What metric would move first if Test Data became the bottleneck?

## Mastery Prompt

Explain Test Data from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
