# Domain-Specific Examples: Test Data

## Domain Lens

Category domain: quality and performance engineering

Use Test Data to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
