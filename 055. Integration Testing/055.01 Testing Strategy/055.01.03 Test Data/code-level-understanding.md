# Code-Level Understanding: Test Data

## Example Exercise

Build a small Integration Testing example that demonstrates Test Data with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Test Data example.
