# Code-Level Understanding: Test Pyramid

## Example Exercise

Build a small Integration Testing example that demonstrates Test Pyramid with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Test Pyramid example.
