# Core Concepts: Test Pyramid

## Definition

Test Pyramid is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Testing Strategy.
...
Use Test Pyramid to reason about:
