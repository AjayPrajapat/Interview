# Validation Questions: Test Pyramid

## Conceptual Questions

1. What problem does Test Pyramid solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Test Pyramid?
...
2. What metric would move first if Test Pyramid became the bottleneck?

## Mastery Prompt

Explain Test Pyramid from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
