# Core Concepts: Release Gates

## Definition

Release Gates is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Production Confidence.
...
Use Release Gates to reason about:
