# Validation Questions: Regression Detection

## Conceptual Questions

1. What problem does Regression Detection solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Regression Detection?
...
2. What metric would move first if Regression Detection became the bottleneck?

## Mastery Prompt

Explain Regression Detection from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
