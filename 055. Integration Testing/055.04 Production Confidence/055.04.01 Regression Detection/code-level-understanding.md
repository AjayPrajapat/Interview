# Code-Level Understanding: Regression Detection

## Example Exercise

Build a small Integration Testing example that demonstrates Regression Detection with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Regression Detection example.
