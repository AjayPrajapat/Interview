# Domain-Specific Examples: Regression Detection

## Domain Lens

Category domain: quality and performance engineering

Use Regression Detection to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
...
In Integration Testing, this example should translate into:
