# Core Concepts: Regression Detection

## Definition

Regression Detection is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Production Confidence.
...
- It gives engineers a shared vocabulary for reasoning about Production Confidence.
...
Use Regression Detection to reason about:
...
- The Production Confidence layer decides which path should execute.
