# Core Concepts: Contract Safety

## Definition

Contract Safety is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Production Confidence.
...
Use Contract Safety to reason about:
