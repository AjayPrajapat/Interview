# Learning Objectives: Contract Safety

## By The End, You Should Be Able To

- Define Contract Safety in the context of Integration Testing without relying on memorized wording.
- Explain why Contract Safety belongs under Production Confidence and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Contract Safety.
