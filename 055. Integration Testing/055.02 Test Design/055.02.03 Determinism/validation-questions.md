# Validation Questions: Determinism

## Conceptual Questions

1. What problem does Determinism solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Determinism?
...
2. What metric would move first if Determinism became the bottleneck?

## Mastery Prompt

Explain Determinism from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
