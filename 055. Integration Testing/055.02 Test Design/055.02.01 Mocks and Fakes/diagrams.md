# Diagrams: 055.02.01 Mocks and Fakes

Category: Integration Testing

Topic: 055.02 Test Design

Use these diagrams to understand Mocks and Fakes visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.

## 1. Concept Map

```mermaid
flowchart TD
  A["Integration Testing"] --> B["055.02 Test Design"]
  B --> C["Mocks and Fakes"]
  C --> D["Definition"]
...
flowchart TD
  ...
  C --> D["Apply Mocks and Fakes Rules"]
...
sequenceDiagram
  ...
  participant Core as Mocks and Fakes
  participant State
...
Do not optimize Mocks and Fakes by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Mocks and Fakes"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Mocks and Fakes"] --> B{"Clear Owner?"}
