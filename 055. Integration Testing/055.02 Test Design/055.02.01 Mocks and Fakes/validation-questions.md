# Validation Questions: Mocks and Fakes

## Conceptual Questions

1. What problem does Mocks and Fakes solve in Integration Testing?
...
1. A production issue appears only under high traffic. How would you investigate Mocks and Fakes?
...
2. What metric would move first if Mocks and Fakes became the bottleneck?

## Mastery Prompt

Explain Mocks and Fakes from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
