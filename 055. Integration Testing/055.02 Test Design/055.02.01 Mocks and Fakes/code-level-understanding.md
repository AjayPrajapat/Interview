# Code-Level Understanding: Mocks and Fakes

## Example Exercise

Build a small Integration Testing example that demonstrates Mocks and Fakes with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Mocks and Fakes example.
