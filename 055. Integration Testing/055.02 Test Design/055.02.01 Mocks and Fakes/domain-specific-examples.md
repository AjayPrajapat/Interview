# Domain-Specific Examples: Mocks and Fakes

## Domain Lens

Category domain: quality and performance engineering

Use Mocks and Fakes to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
