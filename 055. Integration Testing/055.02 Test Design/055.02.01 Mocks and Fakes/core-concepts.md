# Core Concepts: Mocks and Fakes

## Definition

Mocks and Fakes is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Test Design.
...
- It gives engineers a shared vocabulary for reasoning about Test Design.
...
Use Mocks and Fakes to reason about:
...
- The Test Design layer decides which path should execute.
