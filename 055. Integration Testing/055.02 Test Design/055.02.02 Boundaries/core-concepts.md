...
Boundaries is a core part of Integration Testing that describes a specific behavior, boundary, or engineering decision inside Test Design.
...
Use Boundaries to reason about:
