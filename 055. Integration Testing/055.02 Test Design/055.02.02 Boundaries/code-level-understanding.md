# Code-Level Understanding: Boundaries

## Example Exercise

Build a small Integration Testing example that demonstrates Boundaries with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Boundaries example.
