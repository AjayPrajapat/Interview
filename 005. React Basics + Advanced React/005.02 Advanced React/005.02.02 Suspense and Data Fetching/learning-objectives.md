# Learning Objectives: Suspense and Data Fetching

## By The End, You Should Be Able To

- Define Suspense and Data Fetching in the context of React Basics + Advanced React without relying on memorized wording.
- Explain why Suspense and Data Fetching belongs under Advanced React and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Suspense and Data Fetching.
