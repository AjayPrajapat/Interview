# Quick Reference: Hooks Internals

## Core Definition

Hooks Internals is a React Basics + Advanced React concept inside Advanced React that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
