# Core Concepts: Hooks Internals

## Definition

Hooks Internals is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside Advanced React.
...
Use Hooks Internals to reason about:
