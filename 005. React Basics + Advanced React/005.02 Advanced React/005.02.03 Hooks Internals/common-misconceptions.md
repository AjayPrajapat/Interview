# Common Misconceptions: Hooks Internals
...
Write one sentence explaining what you used to believe about Hooks Internals, then rewrite it with the production constraint included.
