# Common Misconceptions: Concurrent Rendering
...
Write one sentence explaining what you used to believe about Concurrent Rendering, then rewrite it with the production constraint included.
