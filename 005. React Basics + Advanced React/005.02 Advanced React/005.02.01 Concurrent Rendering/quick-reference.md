# Quick Reference: Concurrent Rendering

## Core Definition

Concurrent Rendering is a React Basics + Advanced React concept inside Advanced React that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
