# Common Misconceptions: Components and Props
...
Write one sentence explaining what you used to believe about Components and Props, then rewrite it with the production constraint included.
