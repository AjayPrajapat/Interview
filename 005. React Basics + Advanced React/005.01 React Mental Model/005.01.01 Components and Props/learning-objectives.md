# Learning Objectives: Components and Props

## By The End, You Should Be Able To

- Define Components and Props in the context of React Basics + Advanced React without relying on memorized wording.
- Explain why Components and Props belongs under React Mental Model and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Components and Props.
