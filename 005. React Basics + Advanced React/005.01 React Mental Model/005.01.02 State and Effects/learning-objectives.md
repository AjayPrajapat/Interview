# Learning Objectives: State and Effects

## By The End, You Should Be Able To

- Define State and Effects in the context of React Basics + Advanced React without relying on memorized wording.
- Explain why State and Effects belongs under React Mental Model and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to State and Effects.
