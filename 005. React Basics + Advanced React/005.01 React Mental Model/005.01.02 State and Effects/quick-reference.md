# Quick Reference: State and Effects

## Core Definition

State and Effects is a React Basics + Advanced React concept inside React Mental Model that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
