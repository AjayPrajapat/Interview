# Learning Objectives: Rendering and Reconciliation

## By The End, You Should Be Able To

- Define Rendering and Reconciliation in the context of React Basics + Advanced React without relying on memorized wording.
- Explain why Rendering and Reconciliation belongs under React Mental Model and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Rendering and Reconciliation.
