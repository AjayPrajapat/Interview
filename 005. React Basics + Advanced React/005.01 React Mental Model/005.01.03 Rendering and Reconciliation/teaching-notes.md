# Teaching Notes: Rendering and Reconciliation

## Teach To A Beginner

Start with the problem Rendering and Reconciliation solves. Avoid jargon until the learner can explain the basic behavior.
