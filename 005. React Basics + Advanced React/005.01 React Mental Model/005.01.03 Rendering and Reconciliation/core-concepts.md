# Core Concepts: Rendering and Reconciliation

## Definition

Rendering and Reconciliation is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside React Mental Model.
...
- It gives engineers a shared vocabulary for reasoning about React Mental Model.
...
Use Rendering and Reconciliation to reason about:
...
- The React Mental Model layer decides which path should execute.
