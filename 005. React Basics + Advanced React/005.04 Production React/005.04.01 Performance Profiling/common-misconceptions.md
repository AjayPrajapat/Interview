# Common Misconceptions: Performance Profiling
...
Write one sentence explaining what you used to believe about Performance Profiling, then rewrite it with the production constraint included.
