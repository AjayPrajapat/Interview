# Core Concepts: Design System Integration

## Definition

Design System Integration is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside Production React.
...
- It gives engineers a shared vocabulary for reasoning about Production React.
...
Use Design System Integration to reason about:
...
- The Production React layer decides which path should execute.
