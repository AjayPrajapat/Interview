# Common Misconceptions: Testing Strategy
...
Write one sentence explaining what you used to believe about Testing Strategy, then rewrite it with the production constraint included.
