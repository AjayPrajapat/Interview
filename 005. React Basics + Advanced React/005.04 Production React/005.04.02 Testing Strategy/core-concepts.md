# Core Concepts: Testing Strategy

## Definition

Testing Strategy is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside Production React.
...
Use Testing Strategy to reason about:
