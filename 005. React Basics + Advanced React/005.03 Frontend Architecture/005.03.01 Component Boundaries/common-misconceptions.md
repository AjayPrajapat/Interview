# Common Misconceptions: Component Boundaries
...
Write one sentence explaining what you used to believe about Component Boundaries, then rewrite it with the production constraint included.
