# Code-Level Understanding: State Placement

## Example Exercise

Build a small React Basics + Advanced React example that demonstrates State Placement with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete State Placement example.
