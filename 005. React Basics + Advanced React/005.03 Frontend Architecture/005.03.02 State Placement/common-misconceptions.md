# Common Misconceptions: State Placement
...
Write one sentence explaining what you used to believe about State Placement, then rewrite it with the production constraint included.
