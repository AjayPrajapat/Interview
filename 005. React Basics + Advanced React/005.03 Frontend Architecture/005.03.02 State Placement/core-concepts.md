# Core Concepts: State Placement

## Definition

State Placement is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside Frontend Architecture.
...
Use State Placement to reason about:
