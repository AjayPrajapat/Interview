# Quick Reference: Server Components and Hydration

## Core Definition

Server Components and Hydration is a React Basics + Advanced React concept inside Frontend Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Server Components and Hydration?
- Why does it matter in React Basics + Advanced React?
