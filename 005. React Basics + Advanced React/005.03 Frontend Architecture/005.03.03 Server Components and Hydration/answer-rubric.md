# Answer Rubric: Server Components and Hydration
...
- Defines Server Components and Hydration clearly.
...
- Connects Server Components and Hydration to frontend product engineering.
