# Question Bank: Server Components and Hydration

## Level 1: Foundation

1. Define Server Components and Hydration in your own words.
2. Why does Server Components and Hydration belong under Frontend Architecture?
