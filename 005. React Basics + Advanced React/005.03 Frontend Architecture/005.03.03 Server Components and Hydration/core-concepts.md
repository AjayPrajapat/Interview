# Core Concepts: Server Components and Hydration

## Definition

Server Components and Hydration is a core part of React Basics + Advanced React that describes a specific behavior, boundary, or engineering decision inside Frontend Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Frontend Architecture.
...
Use Server Components and Hydration to reason about:
...
- The Frontend Architecture layer decides which path should execute.
