# Debugging Playbook: Server Components and Hydration

## Start Here

Debug Server Components and Hydration by moving from symptom to invariant, not from stack trace to guess.
