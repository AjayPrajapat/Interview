# Teaching Notes: Server Components and Hydration

## Teach To A Beginner

Start with the problem Server Components and Hydration solves. Avoid jargon until the learner can explain the basic behavior.
