# Common Misconceptions: Server Components and Hydration
...
Write one sentence explaining what you used to believe about Server Components and Hydration, then rewrite it with the production constraint included.
