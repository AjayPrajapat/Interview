...
Access Controls is a Threat Modeling concept inside Security and Privacy Design that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
