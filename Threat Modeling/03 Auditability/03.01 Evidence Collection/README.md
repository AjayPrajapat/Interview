...
Use this folder to build interview-ready depth for Evidence Collection: definition, internals, implementation, production behavior, debugging, and trade-offs.
