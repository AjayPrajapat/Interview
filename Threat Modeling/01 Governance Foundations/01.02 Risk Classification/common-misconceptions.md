# Common Misconceptions: Risk Classification
...
Write one sentence explaining what you used to believe about Risk Classification, then rewrite it with the production constraint included.
