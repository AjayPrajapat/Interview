# Teaching Notes: Continuous Control Monitoring

## Teach To A Beginner

Start with the problem Continuous Control Monitoring solves. Avoid jargon until the learner can explain the basic behavior.
