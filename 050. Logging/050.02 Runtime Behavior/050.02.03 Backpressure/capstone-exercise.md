...
You own a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints. You must design, implement, test, operate, and explain Backpressure for a production system.
