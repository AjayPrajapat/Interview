# Common Misconceptions: Test Pyramid
...
Write one sentence explaining what you used to believe about Test Pyramid, then rewrite it with the production constraint included.
