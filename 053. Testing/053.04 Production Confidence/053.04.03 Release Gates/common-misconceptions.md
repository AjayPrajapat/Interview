# Common Misconceptions: Release Gates
...
Write one sentence explaining what you used to believe about Release Gates, then rewrite it with the production constraint included.
