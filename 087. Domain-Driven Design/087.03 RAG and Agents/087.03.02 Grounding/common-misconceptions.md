# Common Misconceptions: Grounding
...
Write one sentence explaining what you used to believe about Grounding, then rewrite it with the production constraint included.
