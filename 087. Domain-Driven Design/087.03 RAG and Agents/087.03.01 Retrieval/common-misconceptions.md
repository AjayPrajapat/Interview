# Common Misconceptions: Retrieval
...
Write one sentence explaining what you used to believe about Retrieval, then rewrite it with the production constraint included.
