...
Safety is a Domain-Driven Design concept inside Production AI Use that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
