# Common Misconceptions: Evaluation
...
Write one sentence explaining what you used to believe about Evaluation, then rewrite it with the production constraint included.
