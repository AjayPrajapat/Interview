# Common Misconceptions: Model Capabilities
...
Write one sentence explaining what you used to believe about Model Capabilities, then rewrite it with the production constraint included.
