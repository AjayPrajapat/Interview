# Common Misconceptions: Context Windows
...
Write one sentence explaining what you used to believe about Context Windows, then rewrite it with the production constraint included.
