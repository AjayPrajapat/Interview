# Common Misconceptions: Instruction Hierarchy
...
Write one sentence explaining what you used to believe about Instruction Hierarchy, then rewrite it with the production constraint included.
