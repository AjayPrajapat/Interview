# 087.02.01 Instruction Hierarchy

Category: Domain/Driven Design

Topic: 087.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 087.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Domain/Driven Design.
...
- reduce ambiguity in 087.02 Prompt and Workflow Design,
...
In Domain/Driven Design, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 087.02 Prompt and Workflow Design boundary
...
For Domain/Driven Design, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere Domain/Driven Design needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in Domain/Driven Design?
2. What problem does it solve inside 087.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 087.02 Prompt and Workflow Design boundary]
...
- Parent category: Domain/Driven Design
- Parent topic: 087.02 Prompt and Workflow Design
