# Common Misconceptions: Tool Use
...
Write one sentence explaining what you used to believe about Tool Use, then rewrite it with the production constraint included.
