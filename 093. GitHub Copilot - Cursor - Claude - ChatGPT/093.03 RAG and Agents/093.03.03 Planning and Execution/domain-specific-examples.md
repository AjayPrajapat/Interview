# Domain-Specific Examples: Planning and Execution

## Domain Lens

Category domain: AI-assisted engineering

Use Planning and Execution to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
...
In GitHub Copilot / Cursor / Claude / ChatGPT, this example should translate into:
