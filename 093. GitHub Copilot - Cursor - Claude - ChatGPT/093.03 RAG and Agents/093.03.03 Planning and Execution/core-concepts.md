# Core Concepts: Planning and Execution

## Definition

Planning and Execution is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside RAG and Agents.
...
- It gives engineers a shared vocabulary for reasoning about RAG and Agents.
...
Use Planning and Execution to reason about:
...
- The RAG and Agents layer decides which path should execute.
