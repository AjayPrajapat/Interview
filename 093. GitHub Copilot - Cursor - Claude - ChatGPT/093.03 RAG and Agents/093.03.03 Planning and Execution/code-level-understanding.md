# Code-Level Understanding: Planning and Execution

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Planning and Execution with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Planning and Execution example.
