# Core Concepts: Retrieval

## Definition

Retrieval is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside RAG and Agents.
