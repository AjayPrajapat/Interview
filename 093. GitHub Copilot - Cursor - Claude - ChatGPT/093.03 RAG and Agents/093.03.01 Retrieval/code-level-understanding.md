# Code-Level Understanding: Retrieval

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Retrieval with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Retrieval example.
