# Validation Questions: Retrieval

## Conceptual Questions

1. What problem does Retrieval solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Retrieval?
...
2. What metric would move first if Retrieval became the bottleneck?

## Mastery Prompt

Explain Retrieval from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
