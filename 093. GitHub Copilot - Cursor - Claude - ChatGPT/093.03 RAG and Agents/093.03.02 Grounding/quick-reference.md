# Quick Reference: Grounding

## Core Definition

Grounding is a GitHub Copilot / Cursor / Claude / ChatGPT concept inside RAG and Agents that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
