# Domain-Specific Examples: Grounding

## Domain Lens

Category domain: AI-assisted engineering

Use Grounding to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
