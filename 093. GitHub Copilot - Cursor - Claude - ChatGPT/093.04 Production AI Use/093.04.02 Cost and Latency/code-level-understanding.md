# Code-Level Understanding: Cost and Latency

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Cost and Latency with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Cost and Latency example.
