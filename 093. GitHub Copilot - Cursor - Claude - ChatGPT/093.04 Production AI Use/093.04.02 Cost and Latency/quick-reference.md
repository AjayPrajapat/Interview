# Quick Reference: Cost and Latency

## Core Definition

Cost and Latency is a GitHub Copilot / Cursor / Claude / ChatGPT concept inside Production AI Use that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Cost and Latency?
- Why does it matter in GitHub Copilot / Cursor / Claude / ChatGPT?
