# Quick Reference: Quality Control

## Core Definition

Quality Control is a GitHub Copilot / Cursor / Claude / ChatGPT concept inside Production AI Use that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
