# Domain-Specific Examples: Quality Control

## Domain Lens

Category domain: AI-assisted engineering

Use Quality Control to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
