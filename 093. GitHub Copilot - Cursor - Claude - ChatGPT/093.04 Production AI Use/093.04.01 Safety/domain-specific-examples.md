# Domain-Specific Examples: Safety

## Domain Lens

Category domain: AI-assisted engineering

Use Safety to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
