# Validation Questions: Safety

## Conceptual Questions

1. What problem does Safety solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Safety?
...
2. What metric would move first if Safety became the bottleneck?

## Mastery Prompt

Explain Safety from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
