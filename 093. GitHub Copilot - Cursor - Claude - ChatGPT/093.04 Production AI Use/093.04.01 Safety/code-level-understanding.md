# Code-Level Understanding: Safety

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Safety with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Safety example.
