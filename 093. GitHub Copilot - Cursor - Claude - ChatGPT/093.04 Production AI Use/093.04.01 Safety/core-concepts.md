# Core Concepts: Safety

## Definition

Safety is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside Production AI Use.
