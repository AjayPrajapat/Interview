# Code-Level Understanding: Tool Use

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Tool Use with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Tool Use example.
