# Learning Objectives: Tool Use

## By The End, You Should Be Able To

- Define Tool Use in the context of GitHub Copilot / Cursor / Claude / ChatGPT without relying on memorized wording.
- Explain why Tool Use belongs under Prompt and Workflow Design and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Tool Use.
