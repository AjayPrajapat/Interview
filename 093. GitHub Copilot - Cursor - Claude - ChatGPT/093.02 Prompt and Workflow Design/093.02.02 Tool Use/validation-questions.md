# Validation Questions: Tool Use

## Conceptual Questions

1. What problem does Tool Use solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Tool Use?
...
2. What metric would move first if Tool Use became the bottleneck?

## Mastery Prompt

Explain Tool Use from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
