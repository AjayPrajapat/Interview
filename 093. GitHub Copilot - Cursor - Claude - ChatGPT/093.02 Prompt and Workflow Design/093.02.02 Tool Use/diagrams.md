# Diagrams: 093.02.02 Tool Use

Category: GitHub Copilot / Cursor / Claude / ChatGPT

Topic: 093.02 Prompt and Workflow Design

Use these diagrams to understand Tool Use visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
Do not optimize Tool Use by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Tool Use"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Tool Use"] --> B{"Clear Owner?"}
