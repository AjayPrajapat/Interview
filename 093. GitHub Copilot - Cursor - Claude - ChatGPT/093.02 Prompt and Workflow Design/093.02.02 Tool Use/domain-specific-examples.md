# Domain-Specific Examples: Tool Use

## Domain Lens

Category domain: AI-assisted engineering

Use Tool Use to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
