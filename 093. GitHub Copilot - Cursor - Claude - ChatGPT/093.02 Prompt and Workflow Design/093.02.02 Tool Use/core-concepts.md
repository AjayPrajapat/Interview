# Core Concepts: Tool Use

## Definition

Tool Use is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside Prompt and Workflow Design.
