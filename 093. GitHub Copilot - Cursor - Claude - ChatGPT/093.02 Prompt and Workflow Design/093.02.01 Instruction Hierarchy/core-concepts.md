# Core Concepts: Instruction Hierarchy

## Definition

Instruction Hierarchy is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside Prompt and Workflow Design.
...
- It gives engineers a shared vocabulary for reasoning about Prompt and Workflow Design.
...
Use Instruction Hierarchy to reason about:
...
- The Prompt and Workflow Design layer decides which path should execute.
