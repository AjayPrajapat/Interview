# Validation Questions: Instruction Hierarchy

## Conceptual Questions

1. What problem does Instruction Hierarchy solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Instruction Hierarchy?
...
2. What metric would move first if Instruction Hierarchy became the bottleneck?

## Mastery Prompt

Explain Instruction Hierarchy from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
