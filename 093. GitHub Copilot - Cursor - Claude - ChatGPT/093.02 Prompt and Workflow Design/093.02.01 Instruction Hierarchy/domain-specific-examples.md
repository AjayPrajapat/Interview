# Domain-Specific Examples: Instruction Hierarchy

## Domain Lens

Category domain: AI-assisted engineering

Use Instruction Hierarchy to reason about an AI-assisted workflow where prompts, context, tools, evaluation, review, and safety controls affect engineering output.
