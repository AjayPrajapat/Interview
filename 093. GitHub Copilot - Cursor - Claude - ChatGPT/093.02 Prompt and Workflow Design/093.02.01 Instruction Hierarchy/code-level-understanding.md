# Code-Level Understanding: Instruction Hierarchy

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Instruction Hierarchy with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Instruction Hierarchy example.
