# Revision Notes: Instruction Hierarchy

## One-Line Summary

Instruction Hierarchy is a GitHub Copilot / Cursor / Claude / ChatGPT topic that must be understood through definition, internal flow, failure behavior, production usage, and trade-offs.
