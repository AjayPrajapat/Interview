# Validation Questions: Evaluation

## Conceptual Questions

1. What problem does Evaluation solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Evaluation?
...
2. What metric would move first if Evaluation became the bottleneck?

## Mastery Prompt

Explain Evaluation from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
