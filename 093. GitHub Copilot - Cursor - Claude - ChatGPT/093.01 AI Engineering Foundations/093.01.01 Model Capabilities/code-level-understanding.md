# Code-Level Understanding: Model Capabilities

## Example Exercise

Build a small GitHub Copilot / Cursor / Claude / ChatGPT example that demonstrates Model Capabilities with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Model Capabilities example.
