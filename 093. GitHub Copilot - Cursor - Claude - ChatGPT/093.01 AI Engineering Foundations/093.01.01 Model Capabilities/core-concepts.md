# Core Concepts: Model Capabilities

## Definition

Model Capabilities is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside AI Engineering Foundations.
...
- It gives engineers a shared vocabulary for reasoning about AI Engineering Foundations.
...
Use Model Capabilities to reason about:
...
- The AI Engineering Foundations layer decides which path should execute.
