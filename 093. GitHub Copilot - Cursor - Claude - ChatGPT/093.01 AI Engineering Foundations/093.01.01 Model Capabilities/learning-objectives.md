# Learning Objectives: Model Capabilities

## By The End, You Should Be Able To

- Define Model Capabilities in the context of GitHub Copilot / Cursor / Claude / ChatGPT without relying on memorized wording.
- Explain why Model Capabilities belongs under AI Engineering Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Model Capabilities.
