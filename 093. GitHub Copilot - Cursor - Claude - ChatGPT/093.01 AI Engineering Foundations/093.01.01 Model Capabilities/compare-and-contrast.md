# Compare And Contrast: Model Capabilities
...
For Model Capabilities, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
