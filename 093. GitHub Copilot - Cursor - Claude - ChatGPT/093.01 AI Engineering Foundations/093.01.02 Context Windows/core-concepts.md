# Core Concepts: Context Windows

## Definition

Context Windows is a core part of GitHub Copilot / Cursor / Claude / ChatGPT that describes a specific behavior, boundary, or engineering decision inside AI Engineering Foundations.
...
Use Context Windows to reason about:
