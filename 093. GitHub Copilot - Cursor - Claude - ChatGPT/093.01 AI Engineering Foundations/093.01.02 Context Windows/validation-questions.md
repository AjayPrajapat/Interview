# Validation Questions: Context Windows

## Conceptual Questions

1. What problem does Context Windows solve in GitHub Copilot / Cursor / Claude / ChatGPT?
...
1. A production issue appears only under high traffic. How would you investigate Context Windows?
...
2. What metric would move first if Context Windows became the bottleneck?

## Mastery Prompt

Explain Context Windows from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
