# Domain-Specific Examples: Core Principles

## Domain Lens

Category domain: frontend product engineering

Use Core Principles to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
