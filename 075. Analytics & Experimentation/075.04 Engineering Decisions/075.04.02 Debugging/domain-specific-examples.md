# Domain-Specific Examples: Debugging

## Domain Lens

Category domain: frontend product engineering

Use Debugging to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
