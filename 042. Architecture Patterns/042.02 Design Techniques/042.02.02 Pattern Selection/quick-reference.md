...
Pattern Selection is a Architecture Patterns concept inside Design Techniques that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
