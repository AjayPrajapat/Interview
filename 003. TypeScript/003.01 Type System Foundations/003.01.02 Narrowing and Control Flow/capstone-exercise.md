# Capstone Exercise: Narrowing and Control Flow

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Narrowing and Control Flow for a production system.
