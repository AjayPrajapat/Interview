# Common Misconceptions: Narrowing and Control Flow
...
Write one sentence explaining what you used to believe about Narrowing and Control Flow, then rewrite it with the production constraint included.
