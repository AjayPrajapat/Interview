# Core Concepts: Narrowing and Control Flow

## Definition

Narrowing and Control Flow is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Type System Foundations.
...
- It gives engineers a shared vocabulary for reasoning about Type System Foundations.
...
Use Narrowing and Control Flow to reason about:
...
- The Type System Foundations layer decides which path should execute.
