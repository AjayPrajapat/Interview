# Domain-Specific Examples: Narrowing and Control Flow

## Domain Lens

Category domain: language/runtime engineering

Use Narrowing and Control Flow to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
