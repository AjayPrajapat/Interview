# Validation Questions: Narrowing and Control Flow

## Conceptual Questions

1. What problem does Narrowing and Control Flow solve in TypeScript?
...
1. A production issue appears only under high traffic. How would you investigate Narrowing and Control Flow?
...
2. What metric would move first if Narrowing and Control Flow became the bottleneck?

## Mastery Prompt

Explain Narrowing and Control Flow from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
