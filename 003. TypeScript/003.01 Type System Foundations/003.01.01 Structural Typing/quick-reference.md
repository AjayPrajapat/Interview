# Quick Reference: Structural Typing

## Core Definition

Structural Typing is a TypeScript concept inside Type System Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
