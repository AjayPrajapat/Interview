# Learning Objectives: Conditional Types

## By The End, You Should Be Able To

- Define Conditional Types in the context of TypeScript without relying on memorized wording.
- Explain why Conditional Types belongs under Advanced Types and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Conditional Types.
