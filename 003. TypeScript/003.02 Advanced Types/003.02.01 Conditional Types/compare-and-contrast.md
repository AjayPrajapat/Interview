# Compare And Contrast: Conditional Types
...
For Conditional Types, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
