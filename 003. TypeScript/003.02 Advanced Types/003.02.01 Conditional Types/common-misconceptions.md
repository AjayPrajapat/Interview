# Common Misconceptions: Conditional Types
...
Write one sentence explaining what you used to believe about Conditional Types, then rewrite it with the production constraint included.
