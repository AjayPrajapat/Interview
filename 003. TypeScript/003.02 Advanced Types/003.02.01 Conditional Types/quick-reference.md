# Quick Reference: Conditional Types

## Core Definition

Conditional Types is a TypeScript concept inside Advanced Types that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
