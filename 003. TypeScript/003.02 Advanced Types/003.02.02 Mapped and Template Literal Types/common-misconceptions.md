# Common Misconceptions: Mapped and Template Literal Types

## Misconception 1

Knowing syntax is enough. At senior level, you must understand runtime behavior, coercion, allocation, scheduling, and failure modes.
...
Write one sentence explaining what you used to believe about Mapped and Template Literal Types, then rewrite it with the production constraint included.
