# Capstone Exercise: Mapped and Template Literal Types

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Mapped and Template Literal Types for a production system.
