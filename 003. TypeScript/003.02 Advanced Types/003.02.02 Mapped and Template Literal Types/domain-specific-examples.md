# Domain-Specific Examples: Mapped and Template Literal Types

## Domain Lens

Category domain: language/runtime engineering

Use Mapped and Template Literal Types to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
...
In TypeScript, this example should translate into:
