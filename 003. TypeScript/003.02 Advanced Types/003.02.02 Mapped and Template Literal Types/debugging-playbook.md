# Debugging Playbook: Mapped and Template Literal Types

## Start Here

Debug Mapped and Template Literal Types by moving from symptom to invariant, not from stack trace to guess.
