# Learning Objectives: Mapped and Template Literal Types

## By The End, You Should Be Able To

- Define Mapped and Template Literal Types in the context of TypeScript without relying on memorized wording.
- Explain why Mapped and Template Literal Types belongs under Advanced Types and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Mapped and Template Literal Types.
