# Hands-On Lab: Mapped and Template Literal Types

## Goal

Practice Mapped and Template Literal Types through a concrete language/runtime engineering exercise.

## Lab Task

write a minimal TypeScript example, run it in Node.js, then change one assumption and record the output difference
