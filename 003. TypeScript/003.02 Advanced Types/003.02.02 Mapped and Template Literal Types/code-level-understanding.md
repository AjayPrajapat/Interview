# Code-Level Understanding: Mapped and Template Literal Types

## Example Exercise

Build a small TypeScript example that demonstrates Mapped and Template Literal Types with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Mapped and Template Literal Types example.
