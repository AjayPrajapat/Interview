# Validation Questions: Variance and Inference

## Conceptual Questions

1. What problem does Variance and Inference solve in TypeScript?
...
1. A production issue appears only under high traffic. How would you investigate Variance and Inference?
...
2. What metric would move first if Variance and Inference became the bottleneck?

## Mastery Prompt

Explain Variance and Inference from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
