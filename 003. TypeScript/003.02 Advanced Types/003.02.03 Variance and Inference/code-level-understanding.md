# Code-Level Understanding: Variance and Inference

## Example Exercise

Build a small TypeScript example that demonstrates Variance and Inference with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Variance and Inference example.
