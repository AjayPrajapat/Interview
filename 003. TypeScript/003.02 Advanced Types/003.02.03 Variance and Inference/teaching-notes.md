# Teaching Notes: Variance and Inference

## Teach To A Beginner

Start with the problem Variance and Inference solves. Avoid jargon until the learner can explain the basic behavior.
