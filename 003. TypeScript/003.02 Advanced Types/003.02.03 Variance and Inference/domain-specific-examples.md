# Domain-Specific Examples: Variance and Inference

## Domain Lens

Category domain: language/runtime engineering

Use Variance and Inference to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
