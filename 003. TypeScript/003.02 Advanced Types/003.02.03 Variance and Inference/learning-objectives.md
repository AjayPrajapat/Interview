# Learning Objectives: Variance and Inference

## By The End, You Should Be Able To

- Define Variance and Inference in the context of TypeScript without relying on memorized wording.
- Explain why Variance and Inference belongs under Advanced Types and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Variance and Inference.
