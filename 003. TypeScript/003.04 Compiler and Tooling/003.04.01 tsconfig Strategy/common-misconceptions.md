# Common Misconceptions: tsconfig Strategy
...
Write one sentence explaining what you used to believe about tsconfig Strategy, then rewrite it with the production constraint included.
