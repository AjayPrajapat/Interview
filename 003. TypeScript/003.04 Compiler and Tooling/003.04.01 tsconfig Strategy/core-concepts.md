# Core Concepts: tsconfig Strategy

## Definition

tsconfig Strategy is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Compiler and Tooling.
...
Use tsconfig Strategy to reason about:
