# Core Concepts: Declaration Files

## Definition

Declaration Files is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Compiler and Tooling.
...
Use Declaration Files to reason about:
