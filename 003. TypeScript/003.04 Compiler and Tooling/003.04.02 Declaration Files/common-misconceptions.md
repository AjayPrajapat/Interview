# Common Misconceptions: Declaration Files
...
Write one sentence explaining what you used to believe about Declaration Files, then rewrite it with the production constraint included.
