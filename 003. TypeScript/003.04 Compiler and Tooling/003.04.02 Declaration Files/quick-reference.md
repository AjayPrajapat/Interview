# Quick Reference: Declaration Files

## Core Definition

Declaration Files is a TypeScript concept inside Compiler and Tooling that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
