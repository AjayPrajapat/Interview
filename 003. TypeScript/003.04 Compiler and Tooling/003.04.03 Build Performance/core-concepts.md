# Core Concepts: Build Performance

## Definition

Build Performance is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Compiler and Tooling.
...
- It gives engineers a shared vocabulary for reasoning about Compiler and Tooling.
...
Use Build Performance to reason about:
...
- The Compiler and Tooling layer decides which path should execute.
