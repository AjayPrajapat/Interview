# Learning Objectives: Build Performance

## By The End, You Should Be Able To

- Define Build Performance in the context of TypeScript without relying on memorized wording.
- Explain why Build Performance belongs under Compiler and Tooling and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Build Performance.
