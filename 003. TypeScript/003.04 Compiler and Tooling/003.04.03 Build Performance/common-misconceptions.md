# Common Misconceptions: Build Performance
...
Write one sentence explaining what you used to believe about Build Performance, then rewrite it with the production constraint included.
