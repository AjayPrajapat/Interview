# Quick Reference: Build Performance

## Core Definition

Build Performance is a TypeScript concept inside Compiler and Tooling that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
