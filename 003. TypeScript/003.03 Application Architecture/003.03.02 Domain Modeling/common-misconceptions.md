# Common Misconceptions: Domain Modeling
...
Write one sentence explaining what you used to believe about Domain Modeling, then rewrite it with the production constraint included.
