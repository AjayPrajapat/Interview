# Question Bank: Monorepo Type Boundaries

## Level 1: Foundation

1. Define Monorepo Type Boundaries in your own words.
2. Why does Monorepo Type Boundaries belong under Application Architecture?
