# Common Misconceptions: Monorepo Type Boundaries
...
Write one sentence explaining what you used to believe about Monorepo Type Boundaries, then rewrite it with the production constraint included.
