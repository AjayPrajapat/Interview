# Core Concepts: Monorepo Type Boundaries

## Definition

Monorepo Type Boundaries is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Application Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Application Architecture.
...
Use Monorepo Type Boundaries to reason about:
...
- The Application Architecture layer decides which path should execute.
