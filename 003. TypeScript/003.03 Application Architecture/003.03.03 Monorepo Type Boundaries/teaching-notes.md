# Teaching Notes: Monorepo Type Boundaries

## Teach To A Beginner

Start with the problem Monorepo Type Boundaries solves. Avoid jargon until the learner can explain the basic behavior.
