# Validation Questions: API Contracts

## Conceptual Questions

1. What problem does API Contracts solve in TypeScript?
...
1. A production issue appears only under high traffic. How would you investigate API Contracts?
...
2. What metric would move first if API Contracts became the bottleneck?

## Mastery Prompt

Explain API Contracts from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
