# Capstone Exercise: API Contracts

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain API Contracts for a production system.
