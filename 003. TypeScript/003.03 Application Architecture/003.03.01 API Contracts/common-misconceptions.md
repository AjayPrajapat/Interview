# Common Misconceptions: API Contracts
...
Write one sentence explaining what you used to believe about API Contracts, then rewrite it with the production constraint included.
