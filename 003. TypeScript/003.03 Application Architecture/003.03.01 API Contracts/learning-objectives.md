# Learning Objectives: API Contracts

## By The End, You Should Be Able To

- Define API Contracts in the context of TypeScript without relying on memorized wording.
- Explain why API Contracts belongs under Application Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to API Contracts.
