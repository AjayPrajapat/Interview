# Core Concepts: API Contracts

## Definition

API Contracts is a core part of TypeScript that describes a specific behavior, boundary, or engineering decision inside Application Architecture.
...
Use API Contracts to reason about:
