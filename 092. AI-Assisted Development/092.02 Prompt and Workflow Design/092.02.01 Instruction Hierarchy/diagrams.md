# Diagrams: 092.02.01 Instruction Hierarchy
...
```mermaid
flowchart TD
  A["AI/Assisted Development"] --> B["092.02 Prompt and Workflow Design"]
...
For AI/Assisted Development, pay special attention to:
