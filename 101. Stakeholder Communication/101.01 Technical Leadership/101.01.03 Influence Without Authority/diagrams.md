# Diagrams: 101.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Stakeholder Communication"] --> B["101.01 Technical Leadership"]
...
For Stakeholder Communication, pay special attention to:
