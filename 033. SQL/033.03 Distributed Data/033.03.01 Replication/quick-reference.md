...
Replication is a SQL concept inside Distributed Data that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
