# Capstone Exercise: Normalization and Denormalization

## Scenario

You own a high-traffic data access path where schema shape, indexes, transactions, and access patterns determine correctness and latency. You must design, implement, test, operate, and explain Normalization and Denormalization for a production system.
