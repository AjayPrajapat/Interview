# System Design Connections: Normalization and Denormalization

## Connection

Data decisions anchor domain boundaries, consistency guarantees, service autonomy, reporting, compliance, and disaster recovery.

## Design Dimensions

- Boundary: where does Normalization and Denormalization start and stop?
