...
Use Cost and Complexity Trade-offs to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
...
In Caching, this example should translate into:
