# Core Concepts: Leaks and Retainers

## Definition

Leaks and Retainers is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Memory Internals.
...
- It gives engineers a shared vocabulary for reasoning about Memory Internals.
...
Use Leaks and Retainers to reason about:
...
- The Memory Internals layer decides which path should execute.
