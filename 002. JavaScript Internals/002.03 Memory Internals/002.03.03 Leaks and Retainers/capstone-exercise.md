# Capstone Exercise: Leaks and Retainers

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Leaks and Retainers for a production system.
