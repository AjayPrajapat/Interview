# Code-Level Understanding: Leaks and Retainers

## Example Exercise

Build a small JavaScript Internals example that demonstrates Leaks and Retainers with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Leaks and Retainers example.
