# Validation Questions: Garbage Collection

## Conceptual Questions

1. What problem does Garbage Collection solve in JavaScript Internals?
...
1. A production issue appears only under high traffic. How would you investigate Garbage Collection?
...
2. What metric would move first if Garbage Collection became the bottleneck?

## Mastery Prompt

Explain Garbage Collection from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
