# Common Misconceptions: Garbage Collection
...
Write one sentence explaining what you used to believe about Garbage Collection, then rewrite it with the production constraint included.
