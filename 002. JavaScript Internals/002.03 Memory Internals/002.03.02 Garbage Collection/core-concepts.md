# Core Concepts: Garbage Collection

## Definition

Garbage Collection is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Memory Internals.
...
Use Garbage Collection to reason about:
