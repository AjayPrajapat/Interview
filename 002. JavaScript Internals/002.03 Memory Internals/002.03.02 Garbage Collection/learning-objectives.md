# Learning Objectives: Garbage Collection

## By The End, You Should Be Able To

- Define Garbage Collection in the context of JavaScript Internals without relying on memorized wording.
- Explain why Garbage Collection belongs under Memory Internals and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Garbage Collection.
