# Code-Level Understanding: Heap Layout

## Example Exercise

Build a small JavaScript Internals example that demonstrates Heap Layout with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Heap Layout example.
