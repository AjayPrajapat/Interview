# Common Misconceptions: Heap Layout
...
Write one sentence explaining what you used to believe about Heap Layout, then rewrite it with the production constraint included.
