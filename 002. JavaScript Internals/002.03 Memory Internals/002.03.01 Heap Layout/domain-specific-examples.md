# Domain-Specific Examples: Heap Layout

## Domain Lens

Category domain: language/runtime engineering

Use Heap Layout to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
