# Core Concepts: Heap Layout

## Definition

Heap Layout is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Memory Internals.
...
Use Heap Layout to reason about:
