# Domain-Specific Examples: Parsing and AST

## Domain Lens

Category domain: language/runtime engineering

Use Parsing and AST to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
