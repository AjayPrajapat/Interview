# Quick Reference: Parsing and AST

## Core Definition

Parsing and AST is a JavaScript Internals concept inside Engine Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
