# Common Misconceptions: Parsing and AST
...
Write one sentence explaining what you used to believe about Parsing and AST, then rewrite it with the production constraint included.
