# Domain-Specific Examples: Inline Caches and Hidden Classes

## Domain Lens

Category domain: language/runtime engineering

Use Inline Caches and Hidden Classes to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
...
In JavaScript Internals, this example should translate into:
