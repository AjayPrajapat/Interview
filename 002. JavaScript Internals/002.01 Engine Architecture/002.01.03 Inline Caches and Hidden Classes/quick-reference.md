# Quick Reference: Inline Caches and Hidden Classes

## Core Definition

Inline Caches and Hidden Classes is a JavaScript Internals concept inside Engine Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Inline Caches and Hidden Classes?
- Why does it matter in JavaScript Internals?
