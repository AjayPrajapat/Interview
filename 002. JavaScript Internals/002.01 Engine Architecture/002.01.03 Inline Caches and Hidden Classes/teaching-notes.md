# Teaching Notes: Inline Caches and Hidden Classes

## Teach To A Beginner

Start with the problem Inline Caches and Hidden Classes solves. Avoid jargon until the learner can explain the basic behavior.
