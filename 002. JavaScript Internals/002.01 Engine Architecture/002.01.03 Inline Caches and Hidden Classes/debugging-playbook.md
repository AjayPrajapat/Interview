# Debugging Playbook: Inline Caches and Hidden Classes

## Start Here

Debug Inline Caches and Hidden Classes by moving from symptom to invariant, not from stack trace to guess.
