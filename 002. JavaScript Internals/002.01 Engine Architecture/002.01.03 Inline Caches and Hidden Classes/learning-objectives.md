# Learning Objectives: Inline Caches and Hidden Classes

## By The End, You Should Be Able To

- Define Inline Caches and Hidden Classes in the context of JavaScript Internals without relying on memorized wording.
- Explain why Inline Caches and Hidden Classes belongs under Engine Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Inline Caches and Hidden Classes.
