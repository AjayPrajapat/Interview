# Common Misconceptions: Bytecode and JIT
...
Write one sentence explaining what you used to believe about Bytecode and JIT, then rewrite it with the production constraint included.
