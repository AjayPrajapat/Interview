# Learning Objectives: Bytecode and JIT

## By The End, You Should Be Able To

- Define Bytecode and JIT in the context of JavaScript Internals without relying on memorized wording.
- Explain why Bytecode and JIT belongs under Engine Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Bytecode and JIT.
