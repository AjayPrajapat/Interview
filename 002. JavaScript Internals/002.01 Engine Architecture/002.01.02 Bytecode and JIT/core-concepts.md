# Core Concepts: Bytecode and JIT

## Definition

Bytecode and JIT is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Engine Architecture.
...
Use Bytecode and JIT to reason about:
