# Validation Questions: Bytecode and JIT

## Conceptual Questions

1. What problem does Bytecode and JIT solve in JavaScript Internals?
...
1. A production issue appears only under high traffic. How would you investigate Bytecode and JIT?
...
2. What metric would move first if Bytecode and JIT became the bottleneck?

## Mastery Prompt

Explain Bytecode and JIT from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
