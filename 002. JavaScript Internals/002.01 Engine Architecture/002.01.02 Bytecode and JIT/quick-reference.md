# Quick Reference: Bytecode and JIT

## Core Definition

Bytecode and JIT is a JavaScript Internals concept inside Engine Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
