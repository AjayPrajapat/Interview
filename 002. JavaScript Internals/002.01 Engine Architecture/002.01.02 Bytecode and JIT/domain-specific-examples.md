# Domain-Specific Examples: Bytecode and JIT

## Domain Lens

Category domain: language/runtime engineering

Use Bytecode and JIT to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
