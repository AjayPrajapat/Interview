# Core Concepts: Lexical Environments

## Definition

Lexical Environments is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Runtime Semantics.
...
Use Lexical Environments to reason about:
