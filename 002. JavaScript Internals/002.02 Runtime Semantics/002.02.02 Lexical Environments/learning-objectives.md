# Learning Objectives: Lexical Environments

## By The End, You Should Be Able To

- Define Lexical Environments in the context of JavaScript Internals without relying on memorized wording.
- Explain why Lexical Environments belongs under Runtime Semantics and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Lexical Environments.
