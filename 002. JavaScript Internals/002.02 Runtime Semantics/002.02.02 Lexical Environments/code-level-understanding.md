# Code-Level Understanding: Lexical Environments

## Example Exercise

Build a small JavaScript Internals example that demonstrates Lexical Environments with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Lexical Environments example.
