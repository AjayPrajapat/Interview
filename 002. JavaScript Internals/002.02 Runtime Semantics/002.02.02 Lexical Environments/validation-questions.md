# Validation Questions: Lexical Environments

## Conceptual Questions

1. What problem does Lexical Environments solve in JavaScript Internals?
...
1. A production issue appears only under high traffic. How would you investigate Lexical Environments?
...
2. What metric would move first if Lexical Environments became the bottleneck?

## Mastery Prompt

Explain Lexical Environments from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
