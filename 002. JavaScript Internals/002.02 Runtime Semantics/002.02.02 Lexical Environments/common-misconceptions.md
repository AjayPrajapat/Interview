# Common Misconceptions: Lexical Environments
...
Write one sentence explaining what you used to believe about Lexical Environments, then rewrite it with the production constraint included.
