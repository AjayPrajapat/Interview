# Capstone Exercise: Microtasks and Macrotasks

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Microtasks and Macrotasks for a production system.
