# Core Concepts: Microtasks and Macrotasks

## Definition

Microtasks and Macrotasks is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Runtime Semantics.
...
- It gives engineers a shared vocabulary for reasoning about Runtime Semantics.
...
Use Microtasks and Macrotasks to reason about:
...
- The Runtime Semantics layer decides which path should execute.
