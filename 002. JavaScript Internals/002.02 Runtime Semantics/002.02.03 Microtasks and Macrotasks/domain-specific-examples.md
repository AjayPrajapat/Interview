# Domain-Specific Examples: Microtasks and Macrotasks

## Domain Lens

Category domain: language/runtime engineering

Use Microtasks and Macrotasks to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
