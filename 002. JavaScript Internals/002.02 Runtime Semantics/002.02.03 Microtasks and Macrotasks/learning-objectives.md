# Learning Objectives: Microtasks and Macrotasks

## By The End, You Should Be Able To

- Define Microtasks and Macrotasks in the context of JavaScript Internals without relying on memorized wording.
- Explain why Microtasks and Macrotasks belongs under Runtime Semantics and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Microtasks and Macrotasks.
