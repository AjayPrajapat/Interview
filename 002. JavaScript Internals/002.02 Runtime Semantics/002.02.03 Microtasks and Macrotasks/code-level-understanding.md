# Code-Level Understanding: Microtasks and Macrotasks

## Example Exercise

Build a small JavaScript Internals example that demonstrates Microtasks and Macrotasks with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Microtasks and Macrotasks example.
