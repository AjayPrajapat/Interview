# Validation Questions: Microtasks and Macrotasks

## Conceptual Questions

1. What problem does Microtasks and Macrotasks solve in JavaScript Internals?
...
1. A production issue appears only under high traffic. How would you investigate Microtasks and Macrotasks?
...
2. What metric would move first if Microtasks and Macrotasks became the bottleneck?

## Mastery Prompt

Explain Microtasks and Macrotasks from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
