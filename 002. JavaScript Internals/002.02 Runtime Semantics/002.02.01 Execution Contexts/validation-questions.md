# Validation Questions: Execution Contexts

## Conceptual Questions

1. What problem does Execution Contexts solve in JavaScript Internals?
...
1. A production issue appears only under high traffic. How would you investigate Execution Contexts?
...
2. What metric would move first if Execution Contexts became the bottleneck?

## Mastery Prompt

Explain Execution Contexts from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
