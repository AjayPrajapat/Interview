# Code-Level Understanding: Execution Contexts

## Example Exercise

Build a small JavaScript Internals example that demonstrates Execution Contexts with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Execution Contexts example.
