# Quick Reference: Execution Contexts

## Core Definition

Execution Contexts is a JavaScript Internals concept inside Runtime Semantics that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
