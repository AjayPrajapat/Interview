# Learning Objectives: Execution Contexts

## By The End, You Should Be Able To

- Define Execution Contexts in the context of JavaScript Internals without relying on memorized wording.
- Explain why Execution Contexts belongs under Runtime Semantics and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Execution Contexts.
