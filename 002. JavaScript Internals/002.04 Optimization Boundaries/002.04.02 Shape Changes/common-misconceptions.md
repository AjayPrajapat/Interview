# Common Misconceptions: Shape Changes
...
Write one sentence explaining what you used to believe about Shape Changes, then rewrite it with the production constraint included.
