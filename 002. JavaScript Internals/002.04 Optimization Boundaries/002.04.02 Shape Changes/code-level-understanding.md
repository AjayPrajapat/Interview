# Code-Level Understanding: Shape Changes

## Example Exercise

Build a small JavaScript Internals example that demonstrates Shape Changes with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Shape Changes example.
