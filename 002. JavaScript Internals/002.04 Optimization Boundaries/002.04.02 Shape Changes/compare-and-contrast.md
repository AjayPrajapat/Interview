# Compare And Contrast: Shape Changes
...
For Shape Changes, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
