# Core Concepts: Deoptimization

## Definition

Deoptimization is a core part of JavaScript Internals that describes a specific behavior, boundary, or engineering decision inside Optimization Boundaries.
...
Use Deoptimization to reason about:
