# Common Misconceptions: Benchmarking Pitfalls
...
Write one sentence explaining what you used to believe about Benchmarking Pitfalls, then rewrite it with the production constraint included.
