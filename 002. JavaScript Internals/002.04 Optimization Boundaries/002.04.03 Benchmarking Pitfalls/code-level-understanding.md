# Code-Level Understanding: Benchmarking Pitfalls

## Example Exercise

Build a small JavaScript Internals example that demonstrates Benchmarking Pitfalls with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Benchmarking Pitfalls example.
