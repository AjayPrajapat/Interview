...
- Define Optimization in the context of Payment / Notification / Search Systems without relying on memorized wording.
- Explain why Optimization belongs under Engineering Decisions and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Optimization.
