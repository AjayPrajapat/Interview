# Code-Level Understanding: Debugging

## Example Exercise

Build a small Payment / Notification / Search Systems example that demonstrates Debugging with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Debugging example.
