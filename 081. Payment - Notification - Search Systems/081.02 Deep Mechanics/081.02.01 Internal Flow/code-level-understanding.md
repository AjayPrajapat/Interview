# Code-Level Understanding: Internal Flow

## Example Exercise

Build a small Payment / Notification / Search Systems example that demonstrates Internal Flow with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Internal Flow example.
