...
Core Principles is a core part of Payment / Notification / Search Systems that describes a specific behavior, boundary, or engineering decision inside Foundations.
...
Use Core Principles to reason about:
