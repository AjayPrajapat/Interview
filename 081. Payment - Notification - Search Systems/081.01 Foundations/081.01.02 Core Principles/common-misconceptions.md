# Common Misconceptions: Core Principles
...
Write one sentence explaining what you used to believe about Core Principles, then rewrite it with the production constraint included.
