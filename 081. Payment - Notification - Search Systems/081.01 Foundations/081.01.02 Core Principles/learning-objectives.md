...
- Define Core Principles in the context of Payment / Notification / Search Systems without relying on memorized wording.
- Explain why Core Principles belongs under Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Core Principles.
