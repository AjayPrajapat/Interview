# Common Misconceptions: Scaling Constraints
...
Write one sentence explaining what you used to believe about Scaling Constraints, then rewrite it with the production constraint included.
