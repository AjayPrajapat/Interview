# Validation Questions: Scaling Constraints

## Conceptual Questions

1. What problem does Scaling Constraints solve in Payment / Notification / Search Systems?
...
1. A production issue appears only under high traffic. How would you investigate Scaling Constraints?
...
2. What metric would move first if Scaling Constraints became the bottleneck?

## Mastery Prompt

Explain Scaling Constraints from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
