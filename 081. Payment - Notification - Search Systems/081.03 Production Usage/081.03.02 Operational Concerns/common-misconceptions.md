# Common Misconceptions: Operational Concerns
...
Write one sentence explaining what you used to believe about Operational Concerns, then rewrite it with the production constraint included.
