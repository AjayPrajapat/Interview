...
Use Operational Concerns to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
...
In Payment / Notification / Search Systems, this example should translate into:
