# Teaching Notes: Latency and Throughput

## Teach To A Beginner

Start with the problem Latency and Throughput solves. Avoid jargon until the learner can explain the basic behavior.
