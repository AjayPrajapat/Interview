...
Topic: 095.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 095.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in RAG Basics.
...
- reduce ambiguity in 095.02 Prompt and Workflow Design,
...
In RAG Basics, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 095.02 Prompt and Workflow Design boundary
...
For RAG Basics, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere RAG Basics needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in RAG Basics?
2. What problem does it solve inside 095.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 095.02 Prompt and Workflow Design boundary]
...
- Parent category: RAG Basics
- Parent topic: 095.02 Prompt and Workflow Design
