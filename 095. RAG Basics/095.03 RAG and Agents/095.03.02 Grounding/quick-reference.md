...
Grounding is a RAG Basics concept inside RAG and Agents that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
