...
Practice Planning and Execution through a concrete AI-assisted engineering exercise.

## Lab Task

create a prompt, define expected output, run a review checklist, and record failure cases or hallucination risks
