...
Topic: 094.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 094.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in AI Code Review.
...
- reduce ambiguity in 094.02 Prompt and Workflow Design,
...
In AI Code Review, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 094.02 Prompt and Workflow Design boundary
...
For AI Code Review, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere AI Code Review needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in AI Code Review?
2. What problem does it solve inside 094.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 094.02 Prompt and Workflow Design boundary]
...
- Parent category: AI Code Review
- Parent topic: 094.02 Prompt and Workflow Design
