...
Instruction Hierarchy is a AI Code Review topic that must be understood through definition, internal flow, failure behavior, production usage, and trade-offs.
