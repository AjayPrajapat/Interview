...
Instruction Hierarchy is a AI Code Review concept inside Prompt and Workflow Design that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
