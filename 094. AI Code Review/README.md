...
## 094.01 AI Engineering Foundations

### 094.01.01 Model Capabilities

#### 🔹 Core Concepts
- Definition: Understand Model Capabilities as it applies to AI Code Review, including the problem it solves and the boundary it owns.
...
- Example: Implement a small AI Code Review scenario where Model Capabilities has a visible contract, typed inputs, explicit error handling, and test coverage.
...
#### 🔹 Interview Focus
- Common questions: Explain Model Capabilities, describe how it works internally, and show how you would implement or operate it in AI Code Review.
...
### 094.01.02 Context Windows

#### 🔹 Core Concepts
- Definition: Understand Context Windows as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Context Windows has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Context Windows, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
### 094.01.03 Evaluation

#### 🔹 Core Concepts
- Definition: Understand Evaluation as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Evaluation has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Evaluation, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
## 094.02 Prompt and Workflow Design

### 094.02.01 Instruction Hierarchy

#### 🔹 Core Concepts
- Definition: Understand Instruction Hierarchy as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Instruction Hierarchy has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Instruction Hierarchy, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
#### 🔹 Core Concepts
- Definition: Understand Tool Use as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Tool Use has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Tool Use, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
### 094.02.03 Human Review

#### 🔹 Core Concepts
- Definition: Understand Human Review as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Human Review has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Human Review, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
## 094.03 RAG and Agents

### 094.03.01 Retrieval

#### 🔹 Core Concepts
- Definition: Understand Retrieval as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Retrieval has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Retrieval, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
#### 🔹 Core Concepts
- Definition: Understand Grounding as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Grounding has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Grounding, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
### 094.03.03 Planning and Execution

#### 🔹 Core Concepts
- Definition: Understand Planning and Execution as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Planning and Execution has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Planning and Execution, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
## 094.04 Production AI Use

### 094.04.01 Safety

#### 🔹 Core Concepts
- Definition: Understand Safety as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Safety has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Safety, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
### 094.04.02 Cost and Latency

#### 🔹 Core Concepts
- Definition: Understand Cost and Latency as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Cost and Latency has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Cost and Latency, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
...
### 094.04.03 Quality Control

#### 🔹 Core Concepts
- Definition: Understand Quality Control as it applies to AI Code Review, including the problem it solves and the boundary it owns.
- Internal working: Trace the flow from input to processing to output, naming the state transitions, contracts, and dependencies involved.
- Key principles: Prefer explicit contracts, measurable behavior, isolated responsibilities, and designs that degrade predictably under stress.
...
#### 🔹 Code-Level Understanding
- Example: Implement a small AI Code Review scenario where Quality Control has a visible contract, typed inputs, explicit error handling, and test coverage.
- Anti-patterns: Leaky abstraction, over-broad shared state, hidden global configuration, unbounded retries, missing cancellation, and logging without correlation IDs.
- Best practices: Keep interfaces narrow, validate at boundaries, model failures explicitly, add observability at decision points, and make behavior reproducible in tests.
...
#### 🔹 Interview Focus
- Common questions: Explain Quality Control, describe how it works internally, and show how you would implement or operate it in AI Code Review.
- Tricky scenarios: Debug intermittent failures, high tail latency, duplicated work, stale data, memory growth, or behavior that changes only under load.
- Follow-up depth: Be ready to discuss instrumentation, rollback plans, migration strategy, data consistency, and how the design changes at 10x scale.
