# Common Misconceptions: Alerting
...
Write one sentence explaining what you used to believe about Alerting, then rewrite it with the production constraint included.
