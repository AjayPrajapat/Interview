# Common Misconceptions: Load Testing
...
Write one sentence explaining what you used to believe about Load Testing, then rewrite it with the production constraint included.
