...
Use this folder to build interview-ready depth for Graceful Shutdown: definition, internals, implementation, production behavior, debugging, and trade-offs.
