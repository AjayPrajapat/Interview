# Common Misconceptions: API Boundaries
...
Write one sentence explaining what you used to believe about API Boundaries, then rewrite it with the production constraint included.
