# Core Concepts: API Boundaries

## Definition

API Boundaries is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Service Architecture.
...
Use API Boundaries to reason about:
