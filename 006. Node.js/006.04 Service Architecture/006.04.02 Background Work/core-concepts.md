# Core Concepts: Background Work

## Definition

Background Work is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Service Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Service Architecture.
...
Use Background Work to reason about:
...
- The Service Architecture layer decides which path should execute.
