# Quick Reference: Background Work

## Core Definition

Background Work is a Node.js concept inside Service Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
