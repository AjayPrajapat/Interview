# Domain-Specific Examples: Background Work

## Domain Lens

Category domain: backend/API engineering

Use Background Work to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
