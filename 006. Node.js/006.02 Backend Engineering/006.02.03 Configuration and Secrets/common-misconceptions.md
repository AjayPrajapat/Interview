# Common Misconceptions: Configuration and Secrets
...
Write one sentence explaining what you used to believe about Configuration and Secrets, then rewrite it with the production constraint included.
