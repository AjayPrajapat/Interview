# Teaching Notes: Configuration and Secrets

## Teach To A Beginner

Start with the problem Configuration and Secrets solves. Avoid jargon until the learner can explain the basic behavior.
