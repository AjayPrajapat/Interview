# Quick Reference: HTTP Servers

## Core Definition

HTTP Servers is a Node.js concept inside Backend Engineering that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
