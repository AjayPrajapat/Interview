# Domain-Specific Examples: HTTP Servers

## Domain Lens

Category domain: backend/API engineering

Use HTTP Servers to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
