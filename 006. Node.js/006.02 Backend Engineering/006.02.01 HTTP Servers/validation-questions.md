# Validation Questions: HTTP Servers

## Conceptual Questions

1. What problem does HTTP Servers solve in Node.js?
...
1. A production issue appears only under high traffic. How would you investigate HTTP Servers?
...
2. What metric would move first if HTTP Servers became the bottleneck?

## Mastery Prompt

Explain HTTP Servers from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
