# Common Misconceptions: HTTP Servers
...
Write one sentence explaining what you used to believe about HTTP Servers, then rewrite it with the production constraint included.
