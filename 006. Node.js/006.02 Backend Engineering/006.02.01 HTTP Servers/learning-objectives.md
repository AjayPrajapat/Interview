# Learning Objectives: HTTP Servers

## By The End, You Should Be Able To

- Define HTTP Servers in the context of Node.js without relying on memorized wording.
- Explain why HTTP Servers belongs under Backend Engineering and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to HTTP Servers.
