# Core Concepts: Async Error Handling

## Definition

Async Error Handling is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Backend Engineering.
...
Use Async Error Handling to reason about:
