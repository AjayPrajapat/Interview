# Common Misconceptions: Async Error Handling
...
Write one sentence explaining what you used to believe about Async Error Handling, then rewrite it with the production constraint included.
