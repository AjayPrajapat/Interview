# Quick Reference: Streams and Buffers

## Core Definition

Streams and Buffers is a Node.js concept inside Node Runtime that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
