# Core Concepts: Streams and Buffers

## Definition

Streams and Buffers is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Node Runtime.
...
Use Streams and Buffers to reason about:
