# Learning Objectives: Streams and Buffers

## By The End, You Should Be Able To

- Define Streams and Buffers in the context of Node.js without relying on memorized wording.
- Explain why Streams and Buffers belongs under Node Runtime and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Streams and Buffers.
