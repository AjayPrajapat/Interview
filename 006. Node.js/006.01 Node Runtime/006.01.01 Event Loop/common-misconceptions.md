# Common Misconceptions: Event Loop
...
Write one sentence explaining what you used to believe about Event Loop, then rewrite it with the production constraint included.
