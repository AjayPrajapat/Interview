# Domain-Specific Examples: Event Loop

## Domain Lens

Category domain: backend/API engineering

Use Event Loop to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
