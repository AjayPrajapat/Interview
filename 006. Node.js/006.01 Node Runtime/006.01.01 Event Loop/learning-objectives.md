# Learning Objectives: Event Loop

## By The End, You Should Be Able To

- Define Event Loop in the context of Node.js without relying on memorized wording.
- Explain why Event Loop belongs under Node Runtime and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Event Loop.
