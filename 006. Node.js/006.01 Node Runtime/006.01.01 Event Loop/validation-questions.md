# Validation Questions: Event Loop

## Conceptual Questions

1. What problem does Event Loop solve in Node.js?
...
1. A production issue appears only under high traffic. How would you investigate Event Loop?
...
2. What metric would move first if Event Loop became the bottleneck?

## Mastery Prompt

Explain Event Loop from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
