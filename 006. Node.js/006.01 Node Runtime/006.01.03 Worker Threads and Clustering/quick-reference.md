# Quick Reference: Worker Threads and Clustering

## Core Definition

Worker Threads and Clustering is a Node.js concept inside Node Runtime that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Worker Threads and Clustering?
- Why does it matter in Node.js?
