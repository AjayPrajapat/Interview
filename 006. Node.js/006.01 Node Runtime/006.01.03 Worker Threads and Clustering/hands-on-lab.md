# Hands-On Lab: Worker Threads and Clustering

## Goal

Practice Worker Threads and Clustering through a concrete backend/API engineering exercise.

## Lab Task

implement a small endpoint contract with validation, typed result states, timeout handling, and one negative test
