# Common Misconceptions: Worker Threads and Clustering
...
Write one sentence explaining what you used to believe about Worker Threads and Clustering, then rewrite it with the production constraint included.
