# Teaching Notes: Worker Threads and Clustering

## Teach To A Beginner

Start with the problem Worker Threads and Clustering solves. Avoid jargon until the learner can explain the basic behavior.
