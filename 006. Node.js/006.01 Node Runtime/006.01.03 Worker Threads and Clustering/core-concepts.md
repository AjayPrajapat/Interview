# Core Concepts: Worker Threads and Clustering

## Definition

Worker Threads and Clustering is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Node Runtime.
...
- It gives engineers a shared vocabulary for reasoning about Node Runtime.
...
Use Worker Threads and Clustering to reason about:
...
- The Node Runtime layer decides which path should execute.
