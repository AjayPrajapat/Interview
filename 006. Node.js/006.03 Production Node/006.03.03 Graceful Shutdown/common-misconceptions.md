# Common Misconceptions: Graceful Shutdown
...
Write one sentence explaining what you used to believe about Graceful Shutdown, then rewrite it with the production constraint included.
