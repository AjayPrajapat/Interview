# Core Concepts: Graceful Shutdown

## Definition

Graceful Shutdown is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Production Node.
...
- It gives engineers a shared vocabulary for reasoning about Production Node.
...
Use Graceful Shutdown to reason about:
...
- The Production Node layer decides which path should execute.
