# Compare And Contrast: Graceful Shutdown
...
For Graceful Shutdown, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
