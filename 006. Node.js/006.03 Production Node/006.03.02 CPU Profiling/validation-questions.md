# Validation Questions: CPU Profiling

## Conceptual Questions

1. What problem does CPU Profiling solve in Node.js?
...
1. A production issue appears only under high traffic. How would you investigate CPU Profiling?
...
2. What metric would move first if CPU Profiling became the bottleneck?

## Mastery Prompt

Explain CPU Profiling from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
