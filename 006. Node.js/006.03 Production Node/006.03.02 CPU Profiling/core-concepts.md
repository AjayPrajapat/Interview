# Core Concepts: CPU Profiling

## Definition

CPU Profiling is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Production Node.
...
Use CPU Profiling to reason about:
