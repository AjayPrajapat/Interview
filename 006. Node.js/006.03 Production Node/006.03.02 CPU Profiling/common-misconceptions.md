# Common Misconceptions: CPU Profiling
...
Write one sentence explaining what you used to believe about CPU Profiling, then rewrite it with the production constraint included.
