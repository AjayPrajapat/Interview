# Learning Objectives: Memory Leaks

## By The End, You Should Be Able To

- Define Memory Leaks in the context of Node.js without relying on memorized wording.
- Explain why Memory Leaks belongs under Production Node and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Memory Leaks.
