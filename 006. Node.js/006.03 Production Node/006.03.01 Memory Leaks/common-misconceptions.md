# Common Misconceptions: Memory Leaks
...
Write one sentence explaining what you used to believe about Memory Leaks, then rewrite it with the production constraint included.
