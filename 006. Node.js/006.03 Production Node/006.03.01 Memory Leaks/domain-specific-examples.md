# Domain-Specific Examples: Memory Leaks

## Domain Lens

Category domain: backend/API engineering

Use Memory Leaks to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
