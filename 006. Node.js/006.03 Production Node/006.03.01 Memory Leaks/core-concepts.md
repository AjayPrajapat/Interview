# Core Concepts: Memory Leaks

## Definition

Memory Leaks is a core part of Node.js that describes a specific behavior, boundary, or engineering decision inside Production Node.
...
Use Memory Leaks to reason about:
