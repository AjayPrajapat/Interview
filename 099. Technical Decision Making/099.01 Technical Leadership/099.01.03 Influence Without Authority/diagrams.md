# Diagrams: 099.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Technical Decision Making"] --> B["099.01 Technical Leadership"]
...
For Technical Decision Making, pay special attention to:
