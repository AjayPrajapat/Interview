# Domain-Specific Examples: Service Health

## Domain Lens

Category domain: platform and operations engineering

Use Service Health to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
