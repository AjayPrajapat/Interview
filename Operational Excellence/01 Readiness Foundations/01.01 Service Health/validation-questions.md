# Validation Questions: Service Health

## Conceptual Questions

1. What problem does Service Health solve in Operational Excellence?
...
1. A production issue appears only under high traffic. How would you investigate Service Health?
...
2. What metric would move first if Service Health became the bottleneck?

## Mastery Prompt

Explain Service Health from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
