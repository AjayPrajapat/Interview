# Code-Level Understanding: Service Health

## Example Exercise

Build a small Operational Excellence example that demonstrates Service Health with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Service Health example.
