# Domain-Specific Examples: Backpressure Signals

## Domain Lens

Category domain: platform and operations engineering

Use Backpressure Signals to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
