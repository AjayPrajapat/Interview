# Quick Reference: Backpressure Signals

## Core Definition

Backpressure Signals is a Operational Excellence concept inside Runtime Pressure that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
