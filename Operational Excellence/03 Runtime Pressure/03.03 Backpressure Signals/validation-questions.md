# Validation Questions: Backpressure Signals

## Conceptual Questions

1. What problem does Backpressure Signals solve in Operational Excellence?
...
1. A production issue appears only under high traffic. How would you investigate Backpressure Signals?
...
2. What metric would move first if Backpressure Signals became the bottleneck?

## Mastery Prompt

Explain Backpressure Signals from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
