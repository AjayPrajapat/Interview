# Domain-Specific Examples: Cost and Reliability Trade-offs

## Domain Lens

Category domain: platform and operations engineering

Use Cost and Reliability Trade-offs to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
...
In Operational Excellence, this example should translate into:
