# Domain-Specific Examples: Capacity Forecasting

## Domain Lens

Category domain: platform and operations engineering

Use Capacity Forecasting to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
