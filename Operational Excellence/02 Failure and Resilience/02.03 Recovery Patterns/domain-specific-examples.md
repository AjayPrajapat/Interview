# Domain-Specific Examples: Recovery Patterns

## Domain Lens

Category domain: platform and operations engineering

Use Recovery Patterns to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
