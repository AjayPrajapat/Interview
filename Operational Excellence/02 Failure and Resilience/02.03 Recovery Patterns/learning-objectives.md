# Learning Objectives: Recovery Patterns

## By The End, You Should Be Able To

- Define Recovery Patterns in the context of Operational Excellence without relying on memorized wording.
- Explain why Recovery Patterns belongs under Failure and Resilience and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Recovery Patterns.
