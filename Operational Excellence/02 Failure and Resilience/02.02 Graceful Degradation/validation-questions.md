# Validation Questions: Graceful Degradation

## Conceptual Questions

1. What problem does Graceful Degradation solve in Operational Excellence?
...
1. A production issue appears only under high traffic. How would you investigate Graceful Degradation?
...
2. What metric would move first if Graceful Degradation became the bottleneck?

## Mastery Prompt

Explain Graceful Degradation from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
