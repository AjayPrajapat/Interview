...
Graceful Degradation is a core part of Operational Excellence that describes a specific behavior, boundary, or engineering decision inside Failure and Resilience.
...
- It gives engineers a shared vocabulary for reasoning about Failure and Resilience.
...
Use Graceful Degradation to reason about:
