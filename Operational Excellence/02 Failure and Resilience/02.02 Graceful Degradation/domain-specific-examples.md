# Domain-Specific Examples: Graceful Degradation

## Domain Lens

Category domain: platform and operations engineering

Use Graceful Degradation to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
