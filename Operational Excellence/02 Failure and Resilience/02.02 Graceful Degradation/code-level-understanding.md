# Code-Level Understanding: Graceful Degradation

## Example Exercise

Build a small Operational Excellence example that demonstrates Graceful Degradation with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Graceful Degradation example.
