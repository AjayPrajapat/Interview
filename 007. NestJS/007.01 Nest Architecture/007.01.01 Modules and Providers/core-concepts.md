# Core Concepts: Modules and Providers

## Definition

Modules and Providers is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Nest Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Nest Architecture.
...
Use Modules and Providers to reason about:
...
- The Nest Architecture layer decides which path should execute.
