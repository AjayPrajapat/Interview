...
- Define Dependency Injection in the context of NestJS without relying on memorized wording.
- Explain why Dependency Injection belongs under Nest Architecture and what dependency it creates for later topics.
