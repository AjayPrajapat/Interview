# Code-Level Understanding: Controllers and Pipes

## Example Exercise

Build a small NestJS example that demonstrates Controllers and Pipes with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Controllers and Pipes example.
