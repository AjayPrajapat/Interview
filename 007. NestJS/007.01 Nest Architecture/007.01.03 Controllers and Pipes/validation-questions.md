# Validation Questions: Controllers and Pipes

## Conceptual Questions

1. What problem does Controllers and Pipes solve in NestJS?
...
1. A production issue appears only under high traffic. How would you investigate Controllers and Pipes?
...
2. What metric would move first if Controllers and Pipes became the bottleneck?

## Mastery Prompt

Explain Controllers and Pipes from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
