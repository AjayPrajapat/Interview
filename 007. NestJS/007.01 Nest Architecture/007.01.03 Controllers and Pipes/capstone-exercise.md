# Capstone Exercise: Controllers and Pipes

## Scenario

You own a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract. You must design, implement, test, operate, and explain Controllers and Pipes for a production system.
