# Learning Objectives: Controllers and Pipes

## By The End, You Should Be Able To

- Define Controllers and Pipes in the context of NestJS without relying on memorized wording.
- Explain why Controllers and Pipes belongs under Nest Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Controllers and Pipes.
