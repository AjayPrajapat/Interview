# Domain-Specific Examples: Controllers and Pipes

## Domain Lens

Category domain: backend/API engineering

Use Controllers and Pipes to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
