# Core Concepts: Controllers and Pipes

## Definition

Controllers and Pipes is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Nest Architecture.
...
Use Controllers and Pipes to reason about:
