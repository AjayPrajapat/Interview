# Validation Questions: Performance

## Conceptual Questions

1. What problem does Performance solve in NestJS?
...
1. A production issue appears only under high traffic. How would you investigate Performance?
...
2. What metric would move first if Performance became the bottleneck?

## Mastery Prompt

Explain Performance from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
