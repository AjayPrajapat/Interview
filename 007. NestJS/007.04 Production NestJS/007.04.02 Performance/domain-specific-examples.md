# Domain-Specific Examples: Performance

## Domain Lens

Category domain: backend/API engineering

Use Performance to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
