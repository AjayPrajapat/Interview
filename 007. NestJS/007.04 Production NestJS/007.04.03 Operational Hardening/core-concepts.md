# Core Concepts: Operational Hardening

## Definition

Operational Hardening is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Production NestJS.
...
- It gives engineers a shared vocabulary for reasoning about Production NestJS.
...
Use Operational Hardening to reason about:
...
- The Production NestJS layer decides which path should execute.
