# Core Concepts: Testing Modules

## Definition

Testing Modules is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Production NestJS.
...
Use Testing Modules to reason about:
