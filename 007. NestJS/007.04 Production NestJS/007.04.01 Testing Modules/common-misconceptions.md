# Common Misconceptions: Testing Modules
...
Write one sentence explaining what you used to believe about Testing Modules, then rewrite it with the production constraint included.
