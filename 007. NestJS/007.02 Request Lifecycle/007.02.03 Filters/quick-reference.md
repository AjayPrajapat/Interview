...
Filters is a NestJS concept inside Request Lifecycle that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
