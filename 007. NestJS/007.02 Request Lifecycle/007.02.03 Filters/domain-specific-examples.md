# Domain-Specific Examples: Filters

## Domain Lens

Category domain: backend/API engineering

Use Filters to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
