# Validation Questions: Interceptors

## Conceptual Questions

1. What problem does Interceptors solve in NestJS?
...
1. A production issue appears only under high traffic. How would you investigate Interceptors?
...
2. What metric would move first if Interceptors became the bottleneck?

## Mastery Prompt

Explain Interceptors from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
