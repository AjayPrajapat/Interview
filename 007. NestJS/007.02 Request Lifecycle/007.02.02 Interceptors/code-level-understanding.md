# Code-Level Understanding: Interceptors

## Example Exercise

Build a small NestJS example that demonstrates Interceptors with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Interceptors example.
