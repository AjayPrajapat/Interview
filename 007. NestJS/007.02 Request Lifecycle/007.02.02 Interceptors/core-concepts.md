...
Interceptors is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Request Lifecycle.
...
- It gives engineers a shared vocabulary for reasoning about Request Lifecycle.
...
Use Interceptors to reason about:
...
- The Request Lifecycle layer decides which path should execute.
