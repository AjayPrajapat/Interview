# Domain-Specific Examples: CQRS

## Domain Lens

Category domain: backend/API engineering

Use CQRS to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
