# Common Misconceptions: Event Emitters
...
Write one sentence explaining what you used to believe about Event Emitters, then rewrite it with the production constraint included.
