# Validation Questions: Event Emitters

## Conceptual Questions

1. What problem does Event Emitters solve in NestJS?
...
1. A production issue appears only under high traffic. How would you investigate Event Emitters?
...
2. What metric would move first if Event Emitters became the bottleneck?

## Mastery Prompt

Explain Event Emitters from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
