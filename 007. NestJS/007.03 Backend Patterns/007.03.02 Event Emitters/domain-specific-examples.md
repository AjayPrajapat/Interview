# Domain-Specific Examples: Event Emitters

## Domain Lens

Category domain: backend/API engineering

Use Event Emitters to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
