# Core Concepts: Event Emitters

## Definition

Event Emitters is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Backend Patterns.
...
Use Event Emitters to reason about:
