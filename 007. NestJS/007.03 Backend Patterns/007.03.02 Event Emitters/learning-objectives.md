# Learning Objectives: Event Emitters

## By The End, You Should Be Able To

- Define Event Emitters in the context of NestJS without relying on memorized wording.
- Explain why Event Emitters belongs under Backend Patterns and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Event Emitters.
