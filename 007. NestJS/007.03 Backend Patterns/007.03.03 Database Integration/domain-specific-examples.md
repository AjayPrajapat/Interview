# Domain-Specific Examples: Database Integration

## Domain Lens

Category domain: backend/API engineering

Use Database Integration to reason about a request path that validates input, authorizes access, performs work, emits telemetry, and returns a stable contract.
