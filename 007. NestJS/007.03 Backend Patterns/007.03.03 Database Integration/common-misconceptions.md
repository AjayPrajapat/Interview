# Common Misconceptions: Database Integration
...
Write one sentence explaining what you used to believe about Database Integration, then rewrite it with the production constraint included.
