# Core Concepts: Database Integration

## Definition

Database Integration is a core part of NestJS that describes a specific behavior, boundary, or engineering decision inside Backend Patterns.
...
- It gives engineers a shared vocabulary for reasoning about Backend Patterns.
...
Use Database Integration to reason about:
...
- The Backend Patterns layer decides which path should execute.
