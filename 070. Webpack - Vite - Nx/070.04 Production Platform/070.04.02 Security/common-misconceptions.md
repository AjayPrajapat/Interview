# Common Misconceptions: Security
...
Write one sentence explaining what you used to believe about Security, then rewrite it with the production constraint included.
