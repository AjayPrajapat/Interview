# Common Misconceptions: Testing Gates
...
Write one sentence explaining what you used to believe about Testing Gates, then rewrite it with the production constraint included.
