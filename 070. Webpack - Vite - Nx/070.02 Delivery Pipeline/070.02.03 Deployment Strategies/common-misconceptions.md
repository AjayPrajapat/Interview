# Common Misconceptions: Deployment Strategies
...
Write one sentence explaining what you used to believe about Deployment Strategies, then rewrite it with the production constraint included.
