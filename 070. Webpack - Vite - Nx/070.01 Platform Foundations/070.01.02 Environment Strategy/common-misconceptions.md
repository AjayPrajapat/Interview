# Common Misconceptions: Environment Strategy
...
Write one sentence explaining what you used to believe about Environment Strategy, then rewrite it with the production constraint included.
