# Common Misconceptions: Runtime Packaging
...
Write one sentence explaining what you used to believe about Runtime Packaging, then rewrite it with the production constraint included.
