# Common Misconceptions: Dependency Boundaries
...
Write one sentence explaining what you used to believe about Dependency Boundaries, then rewrite it with the production constraint included.
