# Diagrams: 107.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Trade/off Communication"] --> B["107.01 Technical Leadership"]
...
For Trade/off Communication, pay special attention to:
