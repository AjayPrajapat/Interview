# Common Misconceptions: Bundle Optimization
...
Write one sentence explaining what you used to believe about Bundle Optimization, then rewrite it with the production constraint included.
