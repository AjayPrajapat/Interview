...
Use this folder to build interview-ready depth for Bundle Optimization: definition, internals, implementation, production behavior, debugging, and trade-offs.
