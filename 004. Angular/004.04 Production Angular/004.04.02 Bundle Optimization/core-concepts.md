# Core Concepts: Bundle Optimization

## Definition

Bundle Optimization is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside Production Angular.
...
Use Bundle Optimization to reason about:
