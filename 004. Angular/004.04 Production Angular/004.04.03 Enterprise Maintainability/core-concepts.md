# Core Concepts: Enterprise Maintainability

## Definition

Enterprise Maintainability is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside Production Angular.
...
- It gives engineers a shared vocabulary for reasoning about Production Angular.
...
Use Enterprise Maintainability to reason about:
...
- The Production Angular layer decides which path should execute.
