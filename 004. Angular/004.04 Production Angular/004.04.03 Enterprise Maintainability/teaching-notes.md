# Teaching Notes: Enterprise Maintainability

## Teach To A Beginner

Start with the problem Enterprise Maintainability solves. Avoid jargon until the learner can explain the basic behavior.
