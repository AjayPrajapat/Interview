# Mental Models: Modules and Standalone Components

## Core Model

Think of Modules and Standalone Components as a contract between intent, state, execution, and observation.
