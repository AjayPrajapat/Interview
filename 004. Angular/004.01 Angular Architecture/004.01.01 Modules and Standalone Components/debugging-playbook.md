# Debugging Playbook: Modules and Standalone Components

## Start Here

Debug Modules and Standalone Components by moving from symptom to invariant, not from stack trace to guess.
