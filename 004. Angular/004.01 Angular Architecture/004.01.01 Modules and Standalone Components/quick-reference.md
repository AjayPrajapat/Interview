# Quick Reference: Modules and Standalone Components

## Core Definition

Modules and Standalone Components is a Angular concept inside Angular Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Modules and Standalone Components?
- Why does it matter in Angular?
