# Hands-On Lab: Modules and Standalone Components

## Goal

Practice Modules and Standalone Components through a concrete frontend product engineering exercise.

## Lab Task

build a tiny UI state or rendering example, profile it, then add one failure path such as slow network or missing data
