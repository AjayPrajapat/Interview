# Core Concepts: Modules and Standalone Components

## Definition

Modules and Standalone Components is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside Angular Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Angular Architecture.
...
Use Modules and Standalone Components to reason about:
