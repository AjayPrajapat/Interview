# Common Misconceptions: Modules and Standalone Components

## Misconception 1

Frontend is only presentation. In production, frontend code owns latency, accessibility, state correctness, telemetry, and user-visible resilience.
...
Write one sentence explaining what you used to believe about Modules and Standalone Components, then rewrite it with the production constraint included.
