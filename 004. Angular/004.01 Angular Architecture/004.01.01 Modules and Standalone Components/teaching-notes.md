# Teaching Notes: Modules and Standalone Components

## Teach To A Beginner

Start with the problem Modules and Standalone Components solves. Avoid jargon until the learner can explain the basic behavior.
