# Code-Level Understanding: Dependency Injection

## Example Exercise

Build a small Angular example that demonstrates Dependency Injection with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Dependency Injection example.
