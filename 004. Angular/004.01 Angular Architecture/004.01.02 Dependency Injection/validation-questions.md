# Validation Questions: Dependency Injection

## Conceptual Questions

1. What problem does Dependency Injection solve in Angular?
...
1. A production issue appears only under high traffic. How would you investigate Dependency Injection?
...
2. What metric would move first if Dependency Injection became the bottleneck?

## Mastery Prompt

Explain Dependency Injection from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
