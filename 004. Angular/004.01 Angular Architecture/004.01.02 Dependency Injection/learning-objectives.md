# Learning Objectives: Dependency Injection

## By The End, You Should Be Able To

- Define Dependency Injection in the context of Angular without relying on memorized wording.
- Explain why Dependency Injection belongs under Angular Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Dependency Injection.
