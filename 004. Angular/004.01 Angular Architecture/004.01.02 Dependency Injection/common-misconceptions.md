# Common Misconceptions: Dependency Injection
...
Write one sentence explaining what you used to believe about Dependency Injection, then rewrite it with the production constraint included.
