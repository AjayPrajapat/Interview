# Validation Questions: Routing and Lazy Loading

## Conceptual Questions

1. What problem does Routing and Lazy Loading solve in Angular?
...
1. A production issue appears only under high traffic. How would you investigate Routing and Lazy Loading?
...
2. What metric would move first if Routing and Lazy Loading became the bottleneck?

## Mastery Prompt

Explain Routing and Lazy Loading from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
