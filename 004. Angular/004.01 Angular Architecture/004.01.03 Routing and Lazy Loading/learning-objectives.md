# Learning Objectives: Routing and Lazy Loading

## By The End, You Should Be Able To

- Define Routing and Lazy Loading in the context of Angular without relying on memorized wording.
- Explain why Routing and Lazy Loading belongs under Angular Architecture and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Routing and Lazy Loading.
