# Teaching Notes: Routing and Lazy Loading

## Teach To A Beginner

Start with the problem Routing and Lazy Loading solves. Avoid jargon until the learner can explain the basic behavior.
