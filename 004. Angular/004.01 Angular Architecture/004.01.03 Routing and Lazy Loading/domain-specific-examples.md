# Domain-Specific Examples: Routing and Lazy Loading

## Domain Lens

Category domain: frontend product engineering

Use Routing and Lazy Loading to reason about a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable.
