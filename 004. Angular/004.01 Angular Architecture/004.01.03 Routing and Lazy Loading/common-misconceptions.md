# Common Misconceptions: Routing and Lazy Loading
...
Write one sentence explaining what you used to believe about Routing and Lazy Loading, then rewrite it with the production constraint included.
