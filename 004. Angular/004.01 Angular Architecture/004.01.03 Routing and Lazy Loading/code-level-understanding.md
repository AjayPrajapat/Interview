# Code-Level Understanding: Routing and Lazy Loading

## Example Exercise

Build a small Angular example that demonstrates Routing and Lazy Loading with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Routing and Lazy Loading example.
