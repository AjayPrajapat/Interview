# Capstone Exercise: Routing and Lazy Loading

## Scenario

You own a customer-facing dashboard where rendering, state, accessibility, analytics, and network behavior must stay predictable. You must design, implement, test, operate, and explain Routing and Lazy Loading for a production system.
