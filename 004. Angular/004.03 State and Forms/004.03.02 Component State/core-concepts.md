# Core Concepts: Component State

## Definition

Component State is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside State and Forms.
...
Use Component State to reason about:
