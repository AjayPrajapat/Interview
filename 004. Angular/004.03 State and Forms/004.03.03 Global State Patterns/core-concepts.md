# Core Concepts: Global State Patterns

## Definition

Global State Patterns is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside State and Forms.
...
- It gives engineers a shared vocabulary for reasoning about State and Forms.
...
Use Global State Patterns to reason about:
...
- The State and Forms layer decides which path should execute.
