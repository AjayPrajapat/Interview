# Learning Objectives: Global State Patterns

## By The End, You Should Be Able To

- Define Global State Patterns in the context of Angular without relying on memorized wording.
- Explain why Global State Patterns belongs under State and Forms and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Global State Patterns.
