# Quick Reference: Global State Patterns

## Core Definition

Global State Patterns is a Angular concept inside State and Forms that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
