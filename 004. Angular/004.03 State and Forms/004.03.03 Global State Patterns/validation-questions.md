# Validation Questions: Global State Patterns

## Conceptual Questions

1. What problem does Global State Patterns solve in Angular?
...
1. A production issue appears only under high traffic. How would you investigate Global State Patterns?
...
2. What metric would move first if Global State Patterns became the bottleneck?

## Mastery Prompt

Explain Global State Patterns from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
