# Code-Level Understanding: Global State Patterns

## Example Exercise

Build a small Angular example that demonstrates Global State Patterns with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Global State Patterns example.
