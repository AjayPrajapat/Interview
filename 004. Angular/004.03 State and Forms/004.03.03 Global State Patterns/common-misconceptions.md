# Common Misconceptions: Global State Patterns
...
Write one sentence explaining what you used to believe about Global State Patterns, then rewrite it with the production constraint included.
