# Core Concepts: Reactive Forms

## Definition

Reactive Forms is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside State and Forms.
...
Use Reactive Forms to reason about:
