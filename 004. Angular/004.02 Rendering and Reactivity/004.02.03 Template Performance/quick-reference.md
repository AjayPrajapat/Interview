# Quick Reference: Template Performance

## Core Definition

Template Performance is a Angular concept inside Rendering and Reactivity that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
