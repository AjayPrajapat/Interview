# Core Concepts: Template Performance

## Definition

Template Performance is a core part of Angular that describes a specific behavior, boundary, or engineering decision inside Rendering and Reactivity.
...
Use Template Performance to reason about:
