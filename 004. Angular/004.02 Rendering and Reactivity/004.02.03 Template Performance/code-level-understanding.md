# Code-Level Understanding: Template Performance

## Example Exercise

Build a small Angular example that demonstrates Template Performance with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Template Performance example.
