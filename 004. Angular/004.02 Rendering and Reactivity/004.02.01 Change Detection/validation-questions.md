# Validation Questions: Change Detection

## Conceptual Questions

1. What problem does Change Detection solve in Angular?
...
1. A production issue appears only under high traffic. How would you investigate Change Detection?
...
2. What metric would move first if Change Detection became the bottleneck?

## Mastery Prompt

Explain Change Detection from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
