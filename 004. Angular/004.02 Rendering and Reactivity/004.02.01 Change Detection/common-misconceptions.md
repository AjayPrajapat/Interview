# Common Misconceptions: Change Detection
...
Write one sentence explaining what you used to believe about Change Detection, then rewrite it with the production constraint included.
