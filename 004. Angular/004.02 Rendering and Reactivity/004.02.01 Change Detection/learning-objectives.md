# Learning Objectives: Change Detection

## By The End, You Should Be Able To

- Define Change Detection in the context of Angular without relying on memorized wording.
- Explain why Change Detection belongs under Rendering and Reactivity and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Change Detection.
