# Quick Reference: Change Detection

## Core Definition

Change Detection is a Angular concept inside Rendering and Reactivity that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
