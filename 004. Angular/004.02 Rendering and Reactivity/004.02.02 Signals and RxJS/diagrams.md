# Diagrams: 004.02.02 Signals and RxJS

Category: Angular

Topic: 004.02 Rendering and Reactivity

Use these diagrams to understand Signals and RxJS visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Signals and RxJS Rules"]
...
sequenceDiagram
  ...
  participant Core as Signals and RxJS
  participant State
...
Do not optimize Signals and RxJS by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Signals and RxJS"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Signals and RxJS"] --> B{"Clear Owner?"}
