# Validation Questions: Signals and RxJS

## Conceptual Questions

1. What problem does Signals and RxJS solve in Angular?
...
1. A production issue appears only under high traffic. How would you investigate Signals and RxJS?
...
2. What metric would move first if Signals and RxJS became the bottleneck?

## Mastery Prompt

Explain Signals and RxJS from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
