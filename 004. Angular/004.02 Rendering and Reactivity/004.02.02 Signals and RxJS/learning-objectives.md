# Learning Objectives: Signals and RxJS

## By The End, You Should Be Able To

- Define Signals and RxJS in the context of Angular without relying on memorized wording.
- Explain why Signals and RxJS belongs under Rendering and Reactivity and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Signals and RxJS.
