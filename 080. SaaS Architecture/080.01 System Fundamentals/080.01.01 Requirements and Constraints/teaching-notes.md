# Teaching Notes: Requirements and Constraints

## Teach To A Beginner

Start with the problem Requirements and Constraints solves. Avoid jargon until the learner can explain the basic behavior.
