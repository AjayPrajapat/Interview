# Common Misconceptions: Service Boundaries
...
Write one sentence explaining what you used to believe about Service Boundaries, then rewrite it with the production constraint included.
