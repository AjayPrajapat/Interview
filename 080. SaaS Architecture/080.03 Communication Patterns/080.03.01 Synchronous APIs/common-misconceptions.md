# Common Misconceptions: Synchronous APIs
...
Write one sentence explaining what you used to believe about Synchronous APIs, then rewrite it with the production constraint included.
