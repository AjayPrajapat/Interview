# Diagrams: 079.01.01 Requirements and Constraints
...
```mermaid
flowchart TD
  A["Multi/Tenant Architecture"] --> B["079.01 System Fundamentals"]
...
For Multi/Tenant Architecture, pay special attention to:
