# Domain-Specific Examples: Synchronous APIs

## Domain Lens

Category domain: distributed systems architecture

Use Synchronous APIs to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
