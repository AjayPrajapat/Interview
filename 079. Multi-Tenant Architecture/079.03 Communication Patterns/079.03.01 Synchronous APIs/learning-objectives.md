# Learning Objectives: Synchronous APIs

## By The End, You Should Be Able To

- Define Synchronous APIs in the context of Multi-Tenant Architecture without relying on memorized wording.
- Explain why Synchronous APIs belongs under Communication Patterns and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Synchronous APIs.
