# Core Concepts: Asynchronous Messaging

## Definition

Asynchronous Messaging is a core part of Multi-Tenant Architecture that describes a specific behavior, boundary, or engineering decision inside Communication Patterns.
...
- It gives engineers a shared vocabulary for reasoning about Communication Patterns.
...
Use Asynchronous Messaging to reason about:
...
- The Communication Patterns layer decides which path should execute.
