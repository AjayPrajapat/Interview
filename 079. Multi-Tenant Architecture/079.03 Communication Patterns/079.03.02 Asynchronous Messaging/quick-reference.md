# Quick Reference: Asynchronous Messaging

## Core Definition

Asynchronous Messaging is a Multi-Tenant Architecture concept inside Communication Patterns that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
