# Quick Reference: Event Contracts

## Core Definition

Event Contracts is a Multi-Tenant Architecture concept inside Communication Patterns that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
