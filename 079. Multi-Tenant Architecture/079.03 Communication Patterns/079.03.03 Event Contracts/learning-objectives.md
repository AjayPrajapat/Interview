# Learning Objectives: Event Contracts

## By The End, You Should Be Able To

- Define Event Contracts in the context of Multi-Tenant Architecture without relying on memorized wording.
- Explain why Event Contracts belongs under Communication Patterns and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Event Contracts.
