# Domain-Specific Examples: Event Contracts

## Domain Lens

Category domain: distributed systems architecture

Use Event Contracts to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
