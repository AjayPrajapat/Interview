# Core Concepts: Event Contracts

## Definition

Event Contracts is a core part of Multi-Tenant Architecture that describes a specific behavior, boundary, or engineering decision inside Communication Patterns.
...
Use Event Contracts to reason about:
