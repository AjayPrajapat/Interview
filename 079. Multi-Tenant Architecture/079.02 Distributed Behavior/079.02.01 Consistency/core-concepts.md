...
Consistency is a core part of Multi-Tenant Architecture that describes a specific behavior, boundary, or engineering decision inside Distributed Behavior.
...
Use Consistency to reason about:
