...
- Define Consistency in the context of Multi-Tenant Architecture without relying on memorized wording.
- Explain why Consistency belongs under Distributed Behavior and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Consistency.
