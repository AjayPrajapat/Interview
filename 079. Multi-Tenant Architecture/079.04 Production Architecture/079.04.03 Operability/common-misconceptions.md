# Common Misconceptions: Operability
...
Write one sentence explaining what you used to believe about Operability, then rewrite it with the production constraint included.
