# Common Misconceptions: Locking and Isolation
...
Write one sentence explaining what you used to believe about Locking and Isolation, then rewrite it with the production constraint included.
