# Common Misconceptions: Refactoring Safety
...
Write one sentence explaining what you used to believe about Refactoring Safety, then rewrite it with the production constraint included.
