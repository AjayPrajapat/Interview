# Common Misconceptions: Modeling
...
Write one sentence explaining what you used to believe about Modeling, then rewrite it with the production constraint included.
