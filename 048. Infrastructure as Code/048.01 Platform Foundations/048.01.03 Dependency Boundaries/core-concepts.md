# Core Concepts: Dependency Boundaries

## Definition

Dependency Boundaries is a core part of Infrastructure as Code that describes a specific behavior, boundary, or engineering decision inside Platform Foundations.
...
- It gives engineers a shared vocabulary for reasoning about Platform Foundations.
...
Use Dependency Boundaries to reason about:
...
- The Platform Foundations layer decides which path should execute.
