# Code-Level Understanding: Dependency Boundaries

## Example Exercise

Build a small Infrastructure as Code example that demonstrates Dependency Boundaries with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Dependency Boundaries example.
