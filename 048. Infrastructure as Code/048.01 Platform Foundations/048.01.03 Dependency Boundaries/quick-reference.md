# Quick Reference: Dependency Boundaries

## Core Definition

Dependency Boundaries is a Infrastructure as Code concept inside Platform Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Dependency Boundaries?
- Why does it matter in Infrastructure as Code?
