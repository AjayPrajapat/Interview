# Domain-Specific Examples: Environment Strategy

## Domain Lens

Category domain: platform and operations engineering

Use Environment Strategy to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
