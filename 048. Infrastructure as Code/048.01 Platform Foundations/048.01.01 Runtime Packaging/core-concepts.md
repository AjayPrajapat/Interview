# Core Concepts: Runtime Packaging

## Definition

Runtime Packaging is a core part of Infrastructure as Code that describes a specific behavior, boundary, or engineering decision inside Platform Foundations.
...
Use Runtime Packaging to reason about:
