# Domain-Specific Examples: Runtime Packaging

## Domain Lens

Category domain: platform and operations engineering

Use Runtime Packaging to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
