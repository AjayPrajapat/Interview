# Learning Objectives: Deployment Strategies

## By The End, You Should Be Able To

- Define Deployment Strategies in the context of Infrastructure as Code without relying on memorized wording.
- Explain why Deployment Strategies belongs under Delivery Pipeline and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Deployment Strategies.
