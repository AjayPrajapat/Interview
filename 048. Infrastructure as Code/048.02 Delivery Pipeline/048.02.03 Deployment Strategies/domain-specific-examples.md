# Domain-Specific Examples: Deployment Strategies

## Domain Lens

Category domain: platform and operations engineering

Use Deployment Strategies to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
...
In Infrastructure as Code, this example should translate into:
