# Revision Notes: Deployment Strategies

## One-Line Summary

Deployment Strategies is a Infrastructure as Code topic that must be understood through definition, internal flow, failure behavior, production usage, and trade-offs.
