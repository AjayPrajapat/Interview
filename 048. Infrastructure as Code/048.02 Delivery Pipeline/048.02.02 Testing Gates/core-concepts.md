# Core Concepts: Testing Gates

## Definition

Testing Gates is a core part of Infrastructure as Code that describes a specific behavior, boundary, or engineering decision inside Delivery Pipeline.
...
- It gives engineers a shared vocabulary for reasoning about Delivery Pipeline.
...
Use Testing Gates to reason about:
