# Quick Reference: Testing Gates

## Core Definition

Testing Gates is a Infrastructure as Code concept inside Delivery Pipeline that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
