# Code-Level Understanding: Testing Gates

## Example Exercise

Build a small Infrastructure as Code example that demonstrates Testing Gates with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Testing Gates example.
