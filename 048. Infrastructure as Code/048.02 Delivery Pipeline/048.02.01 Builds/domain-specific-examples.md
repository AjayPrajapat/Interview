# Domain-Specific Examples: Builds

## Domain Lens

Category domain: platform and operations engineering

Use Builds to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
