# Code-Level Understanding: Builds

## Example Exercise

Build a small Infrastructure as Code example that demonstrates Builds with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Builds example.
