...
- Define Scaling in the context of Infrastructure as Code without relying on memorized wording.
- Explain why Scaling belongs under Cloud Operations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Scaling.
