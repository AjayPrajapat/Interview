# Validation Questions: Scaling

## Conceptual Questions

1. What problem does Scaling solve in Infrastructure as Code?
...
1. A production issue appears only under high traffic. How would you investigate Scaling?
...
2. What metric would move first if Scaling became the bottleneck?

## Mastery Prompt

Explain Scaling from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
