# Domain-Specific Examples: Scaling

## Domain Lens

Category domain: platform and operations engineering

Use Scaling to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
