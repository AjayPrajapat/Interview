# Quick Reference: Cost Control

## Core Definition

Cost Control is a Infrastructure as Code concept inside Cloud Operations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
