# Domain-Specific Examples: Cost Control

## Domain Lens

Category domain: platform and operations engineering

Use Cost Control to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
