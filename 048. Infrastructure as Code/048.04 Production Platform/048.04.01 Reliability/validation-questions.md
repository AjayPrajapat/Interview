# Validation Questions: Reliability

## Conceptual Questions

1. What problem does Reliability solve in Infrastructure as Code?
...
1. A production issue appears only under high traffic. How would you investigate Reliability?
...
2. What metric would move first if Reliability became the bottleneck?

## Mastery Prompt

Explain Reliability from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
