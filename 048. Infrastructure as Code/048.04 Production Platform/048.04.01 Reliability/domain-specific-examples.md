# Domain-Specific Examples: Reliability

## Domain Lens

Category domain: platform and operations engineering

Use Reliability to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
