# Code-Level Understanding: Reliability

## Example Exercise

Build a small Infrastructure as Code example that demonstrates Reliability with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Reliability example.
