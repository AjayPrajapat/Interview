# Learning Objectives: Reliability

## By The End, You Should Be Able To

- Define Reliability in the context of Infrastructure as Code without relying on memorized wording.
- Explain why Reliability belongs under Production Platform and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Reliability.
