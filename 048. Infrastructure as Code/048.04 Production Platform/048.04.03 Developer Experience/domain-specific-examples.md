# Domain-Specific Examples: Developer Experience

## Domain Lens

Category domain: platform and operations engineering

Use Developer Experience to reason about a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints.
