# Core Concepts: Developer Experience

## Definition

Developer Experience is a core part of Infrastructure as Code that describes a specific behavior, boundary, or engineering decision inside Production Platform.
...
- It gives engineers a shared vocabulary for reasoning about Production Platform.
...
Use Developer Experience to reason about:
...
- The Production Platform layer decides which path should execute.
