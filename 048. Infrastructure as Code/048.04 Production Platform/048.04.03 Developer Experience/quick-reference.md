# Quick Reference: Developer Experience

## Core Definition

Developer Experience is a Infrastructure as Code concept inside Production Platform that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
