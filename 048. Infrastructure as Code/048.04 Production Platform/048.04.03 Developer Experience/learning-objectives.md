# Learning Objectives: Developer Experience

## By The End, You Should Be Able To

- Define Developer Experience in the context of Infrastructure as Code without relying on memorized wording.
- Explain why Developer Experience belongs under Production Platform and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Developer Experience.
