# Code-Level Understanding: Security

## Example Exercise

Build a small Infrastructure as Code example that demonstrates Security with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Security example.
