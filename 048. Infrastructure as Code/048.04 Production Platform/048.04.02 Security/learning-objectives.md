...
- Define Security in the context of Infrastructure as Code without relying on memorized wording.
- Explain why Security belongs under Production Platform and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Security.
