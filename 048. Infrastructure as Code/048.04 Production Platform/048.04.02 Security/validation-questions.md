# Validation Questions: Security

## Conceptual Questions

1. What problem does Security solve in Infrastructure as Code?
...
1. A production issue appears only under high traffic. How would you investigate Security?
...
2. What metric would move first if Security became the bottleneck?

## Mastery Prompt

Explain Security from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
