# Diagrams: 103.01.01 Problem Framing

Category: Agile / Scrum / Delivery

Topic: 103.01 Technical Leadership

Use these diagrams to understand Problem Framing visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Problem Framing Rules"]
...
sequenceDiagram
  ...
  participant Core as Problem Framing
  participant State
...
Do not optimize Problem Framing by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Problem Framing"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Problem Framing"] --> B{"Clear Owner?"}
