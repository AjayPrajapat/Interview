# Diagrams: 103.03.02 Stakeholder Alignment

Category: Agile / Scrum / Delivery

Topic: 103.03 Communication

Use these diagrams to understand Stakeholder Alignment visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Stakeholder Alignment Rules"]
...
```text
Work enters Stakeholder Alignment
...
sequenceDiagram
  ...
  participant Core as Stakeholder Alignment
  participant State
...
Do not optimize Stakeholder Alignment by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Stakeholder Alignment"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Stakeholder Alignment"] --> B{"Clear Owner?"}
...
```text
[ ] I can define Stakeholder Alignment.
