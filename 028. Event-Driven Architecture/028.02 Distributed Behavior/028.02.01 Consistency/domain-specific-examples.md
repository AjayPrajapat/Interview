# Domain-Specific Examples: Consistency

## Domain Lens

Category domain: distributed systems architecture

Use Consistency to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
