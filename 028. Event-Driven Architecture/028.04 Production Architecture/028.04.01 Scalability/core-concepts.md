# Core Concepts: Scalability

## Definition

Scalability is a core part of Event-Driven Architecture that describes a specific behavior, boundary, or engineering decision inside Production Architecture.
...
Use Scalability to reason about:
