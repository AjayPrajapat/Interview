# Core Concepts: Operability

## Definition

Operability is a core part of Event-Driven Architecture that describes a specific behavior, boundary, or engineering decision inside Production Architecture.
...
- It gives engineers a shared vocabulary for reasoning about Production Architecture.
...
Use Operability to reason about:
...
- The Production Architecture layer decides which path should execute.
