# Domain-Specific Examples: Operability

## Domain Lens

Category domain: distributed systems architecture

Use Operability to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
