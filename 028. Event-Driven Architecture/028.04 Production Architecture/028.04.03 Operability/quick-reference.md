# Quick Reference: Operability

## Core Definition

Operability is a Event-Driven Architecture concept inside Production Architecture that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
