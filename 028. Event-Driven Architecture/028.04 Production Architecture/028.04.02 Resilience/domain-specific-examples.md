# Domain-Specific Examples: Resilience

## Domain Lens

Category domain: distributed systems architecture

Use Resilience to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
