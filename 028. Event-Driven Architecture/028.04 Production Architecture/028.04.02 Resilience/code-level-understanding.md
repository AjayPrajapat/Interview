# Code-Level Understanding: Resilience

## Example Exercise

Build a small Event-Driven Architecture example that demonstrates Resilience with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Resilience example.
