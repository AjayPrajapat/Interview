# Domain-Specific Examples: Service Boundaries

## Domain Lens

Category domain: distributed systems architecture

Use Service Boundaries to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
