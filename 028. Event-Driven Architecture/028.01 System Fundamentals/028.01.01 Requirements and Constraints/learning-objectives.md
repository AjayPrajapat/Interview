# Learning Objectives: Requirements and Constraints

## By The End, You Should Be Able To

- Define Requirements and Constraints in the context of Event-Driven Architecture without relying on memorized wording.
- Explain why Requirements and Constraints belongs under System Fundamentals and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Requirements and Constraints.
