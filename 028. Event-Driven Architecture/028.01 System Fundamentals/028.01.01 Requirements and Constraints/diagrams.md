# Diagrams: 028.01.01 Requirements and Constraints
...
```mermaid
flowchart TD
  A["Event/Driven Architecture"] --> B["028.01 System Fundamentals"]
...
For Event/Driven Architecture, pay special attention to:
