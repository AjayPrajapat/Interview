# Validation Questions: Requirements and Constraints

## Conceptual Questions

1. What problem does Requirements and Constraints solve in Event-Driven Architecture?
...
1. A production issue appears only under high traffic. How would you investigate Requirements and Constraints?
...
2. What metric would move first if Requirements and Constraints became the bottleneck?

## Mastery Prompt

Explain Requirements and Constraints from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
