# Domain-Specific Examples: Data Flow

## Domain Lens

Category domain: distributed systems architecture

Use Data Flow to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
