# Validation Questions: Synchronous APIs

## Conceptual Questions

1. What problem does Synchronous APIs solve in Event-Driven Architecture?
...
1. A production issue appears only under high traffic. How would you investigate Synchronous APIs?
...
2. What metric would move first if Synchronous APIs became the bottleneck?

## Mastery Prompt

Explain Synchronous APIs from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
