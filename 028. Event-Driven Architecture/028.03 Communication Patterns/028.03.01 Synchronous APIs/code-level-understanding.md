# Code-Level Understanding: Synchronous APIs

## Example Exercise

Build a small Event-Driven Architecture example that demonstrates Synchronous APIs with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Synchronous APIs example.
