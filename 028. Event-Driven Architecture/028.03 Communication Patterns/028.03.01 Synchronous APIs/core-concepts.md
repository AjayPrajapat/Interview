# Core Concepts: Synchronous APIs

## Definition

Synchronous APIs is a core part of Event-Driven Architecture that describes a specific behavior, boundary, or engineering decision inside Communication Patterns.
...
Use Synchronous APIs to reason about:
