# Code-Level Understanding: Event Contracts

## Example Exercise

Build a small Event-Driven Architecture example that demonstrates Event Contracts with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Event Contracts example.
