# Validation Questions: Event Contracts

## Conceptual Questions

1. What problem does Event Contracts solve in Event-Driven Architecture?
...
1. A production issue appears only under high traffic. How would you investigate Event Contracts?
...
2. What metric would move first if Event Contracts became the bottleneck?

## Mastery Prompt

Explain Event Contracts from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
