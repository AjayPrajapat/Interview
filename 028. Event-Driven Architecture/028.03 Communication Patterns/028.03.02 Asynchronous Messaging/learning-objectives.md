# Learning Objectives: Asynchronous Messaging

## By The End, You Should Be Able To

- Define Asynchronous Messaging in the context of Event-Driven Architecture without relying on memorized wording.
- Explain why Asynchronous Messaging belongs under Communication Patterns and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Asynchronous Messaging.
