# Domain-Specific Examples: Asynchronous Messaging

## Domain Lens

Category domain: distributed systems architecture

Use Asynchronous Messaging to reason about a multi-service workflow where data moves through APIs, queues, caches, storage, and asynchronous processors.
...
In Event-Driven Architecture, this example should translate into:
