# Common Misconceptions: Event Contracts
...
Write one sentence explaining what you used to believe about Event Contracts, then rewrite it with the production constraint included.
