# Common Misconceptions: Asynchronous Messaging
...
Write one sentence explaining what you used to believe about Asynchronous Messaging, then rewrite it with the production constraint included.
