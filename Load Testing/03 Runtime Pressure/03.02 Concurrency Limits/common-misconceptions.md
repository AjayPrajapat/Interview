# Common Misconceptions: Concurrency Limits
...
Write one sentence explaining what you used to believe about Concurrency Limits, then rewrite it with the production constraint included.
