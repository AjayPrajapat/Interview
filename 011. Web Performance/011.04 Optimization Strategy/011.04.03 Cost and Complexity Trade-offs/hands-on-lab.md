...
Practice Cost and Complexity Trade-offs through a concrete general software engineering exercise.

## Lab Task

create one small example, one failure scenario, one debugging checklist, and one architecture trade-off
