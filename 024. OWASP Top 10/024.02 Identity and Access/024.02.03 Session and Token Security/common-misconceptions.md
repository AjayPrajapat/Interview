# Common Misconceptions: Session and Token Security
...
Write one sentence explaining what you used to believe about Session and Token Security, then rewrite it with the production constraint included.
