...
Defense in Depth is a OWASP Top 10 concept inside Security Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
