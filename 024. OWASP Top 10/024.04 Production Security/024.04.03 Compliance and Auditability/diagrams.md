# Diagrams: 024.04.03 Compliance and Auditability
...
```mermaid
flowchart TD
  A["OWASP Top 10"] --> B["024.04 Production Security"]
...
For OWASP Top 10, pay special attention to:

- blocked attack attempts, policy violations, audit gaps, exposure window, false positives, and incident response time,
