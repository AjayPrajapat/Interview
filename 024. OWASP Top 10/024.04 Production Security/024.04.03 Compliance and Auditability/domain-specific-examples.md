...
Use Compliance and Auditability to reason about a sensitive user workflow where identity, authorization, data handling, auditability, and threat modeling must align.
...
In OWASP Top 10, this example should translate into:
