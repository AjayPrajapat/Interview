# Teaching Notes: Secrets and Configuration

## Teach To A Beginner

Start with the problem Secrets and Configuration solves. Avoid jargon until the learner can explain the basic behavior.
