...
You own a production service with deployment pipelines, health signals, autoscaling, alerting, rollback, and cost constraints. You must design, implement, test, operate, and explain Cost and Complexity Trade-offs for a production system.
