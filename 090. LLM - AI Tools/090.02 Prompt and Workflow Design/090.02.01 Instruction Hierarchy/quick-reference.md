...
Instruction Hierarchy is a LLM / AI Tools concept inside Prompt and Workflow Design that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
