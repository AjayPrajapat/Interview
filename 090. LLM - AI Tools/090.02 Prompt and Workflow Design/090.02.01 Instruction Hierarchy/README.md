...
Topic: 090.02 Prompt and Workflow Design

## 1. Definition

Instruction Hierarchy is a focused engineering concept inside 090.02 Prompt and Workflow Design. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in LLM / AI Tools.
...
- reduce ambiguity in 090.02 Prompt and Workflow Design,
...
In LLM / AI Tools, Instruction Hierarchy commonly appears as a prompt, evaluation, retrieval pipeline, coding workflow, review loop, agent step, or safety policy.
...
Input / trigger
  ...
  -> enter 090.02 Prompt and Workflow Design boundary
...
For LLM / AI Tools, watch task success rate, hallucination rate, review quality, latency, cost, token usage, and human override rate.
...
Instruction Hierarchy appears in production anywhere LLM / AI Tools needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Instruction Hierarchy, and why does it matter in LLM / AI Tools?
2. What problem does it solve inside 090.02 Prompt and Workflow Design?
...
flowchart TD
  ...
  B --> C[Enter 090.02 Prompt and Workflow Design boundary]
...
- Parent category: LLM / AI Tools
- Parent topic: 090.02 Prompt and Workflow Design
