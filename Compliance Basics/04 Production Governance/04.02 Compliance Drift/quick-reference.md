...
Compliance Drift is a Compliance Basics concept inside Production Governance that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
