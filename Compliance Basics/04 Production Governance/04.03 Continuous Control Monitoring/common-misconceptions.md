# Common Misconceptions: Continuous Control Monitoring
...
Write one sentence explaining what you used to believe about Continuous Control Monitoring, then rewrite it with the production constraint included.
