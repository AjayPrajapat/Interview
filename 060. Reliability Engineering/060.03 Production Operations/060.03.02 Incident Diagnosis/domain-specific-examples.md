# Domain-Specific Examples: Incident Diagnosis

## Domain Lens

Category domain: quality and performance engineering

Use Incident Diagnosis to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
