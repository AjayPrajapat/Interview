# Validation Questions: Incident Diagnosis

## Conceptual Questions

1. What problem does Incident Diagnosis solve in Reliability Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Incident Diagnosis?
...
2. What metric would move first if Incident Diagnosis became the bottleneck?

## Mastery Prompt

Explain Incident Diagnosis from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
