# Validation Questions: Backpressure

## Conceptual Questions

1. What problem does Backpressure solve in Reliability Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Backpressure?
...
2. What metric would move first if Backpressure became the bottleneck?

## Mastery Prompt

Explain Backpressure from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
