# Domain-Specific Examples: Bottlenecks

## Domain Lens

Category domain: quality and performance engineering

Use Bottlenecks to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
