# Learning Objectives: Bottlenecks

## By The End, You Should Be Able To

- Define Bottlenecks in the context of Reliability Engineering without relying on memorized wording.
- Explain why Bottlenecks belongs under Runtime Behavior and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Bottlenecks.
