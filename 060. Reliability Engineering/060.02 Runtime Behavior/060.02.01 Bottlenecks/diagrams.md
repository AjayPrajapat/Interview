# Diagrams: 060.02.01 Bottlenecks

Category: Reliability Engineering

Topic: 060.02 Runtime Behavior

Use these diagrams to understand Bottlenecks visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
sequenceDiagram
  ...
  participant Core as Bottlenecks
  participant State
...
Do not optimize Bottlenecks by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Bottlenecks"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Bottlenecks"] --> B{"Clear Owner?"}
