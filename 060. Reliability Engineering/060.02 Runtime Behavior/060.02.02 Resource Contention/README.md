...
Topic: 060.02 Runtime Behavior

## 1. Definition

Resource Contention is a focused engineering concept inside 060.02 Runtime Behavior. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Reliability Engineering.
...
- reduce ambiguity in 060.02 Runtime Behavior,
...
In Reliability Engineering, Resource Contention commonly appears as a service boundary, data flow, queue, topic, cache, database table, API, worker, or consistency model.

Typical shape:

```txt
Resource Contention production flow
...
Input / trigger
  ...
  -> enter 060.02 Runtime Behavior boundary
...
Resource Contention appears in production anywhere Reliability Engineering needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Resource Contention, and why does it matter in Reliability Engineering?
2. What problem does it solve inside 060.02 Runtime Behavior?
...
flowchart TD
  ...
  B --> C[Enter 060.02 Runtime Behavior boundary]
...
- Parent topic: 060.02 Runtime Behavior
