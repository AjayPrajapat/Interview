# Code-Level Understanding: Resource Contention

## Example Exercise

Build a small Reliability Engineering example that demonstrates Resource Contention with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Resource Contention example.
