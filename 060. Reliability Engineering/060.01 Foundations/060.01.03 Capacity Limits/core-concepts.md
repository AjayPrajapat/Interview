# Core Concepts: Capacity Limits

## Definition

Capacity Limits is a core part of Reliability Engineering that describes a specific behavior, boundary, or engineering decision inside Foundations.
...
Use Capacity Limits to reason about:
