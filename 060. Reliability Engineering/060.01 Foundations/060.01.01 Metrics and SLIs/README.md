...
Metrics and SLIs is a focused engineering concept inside 060.01 Foundations. It describes a behavior, design choice, implementation technique, or operational concern that engineers must understand deeply to build reliable systems in Reliability Engineering.
...
In Reliability Engineering, Metrics and SLIs commonly appears as a service boundary, data flow, queue, topic, cache, database table, API, worker, or consistency model.

Typical shape:

```txt
Metrics and SLIs production flow
...
Metrics and SLIs appears in production anywhere Reliability Engineering needs predictable behavior across real users, real traffic, real failures, and real team boundaries.
...
1. What is Metrics and SLIs, and why does it matter in Reliability Engineering?
