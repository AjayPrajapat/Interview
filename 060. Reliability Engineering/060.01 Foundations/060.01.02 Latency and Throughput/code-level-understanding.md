# Code-Level Understanding: Latency and Throughput

## Example Exercise

Build a small Reliability Engineering example that demonstrates Latency and Throughput with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Latency and Throughput example.
