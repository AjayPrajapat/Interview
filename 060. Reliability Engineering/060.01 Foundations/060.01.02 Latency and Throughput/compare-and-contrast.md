# Compare And Contrast: Latency and Throughput
...
For Latency and Throughput, choose the simplest approach that protects correctness today and leaves a clear path to evolve tomorrow.
