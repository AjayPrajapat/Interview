# Core Concepts: Load Testing

## Definition

Load Testing is a core part of Reliability Engineering that describes a specific behavior, boundary, or engineering decision inside Optimization Strategy.
...
Use Load Testing to reason about:
