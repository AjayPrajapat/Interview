# Validation Questions: Load Testing

## Conceptual Questions

1. What problem does Load Testing solve in Reliability Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Load Testing?
...
2. What metric would move first if Load Testing became the bottleneck?

## Mastery Prompt

Explain Load Testing from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
