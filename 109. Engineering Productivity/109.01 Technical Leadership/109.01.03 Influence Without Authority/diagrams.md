# Diagrams: 109.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Engineering Productivity"] --> B["109.01 Technical Leadership"]
...
For Engineering Productivity, pay special attention to:
