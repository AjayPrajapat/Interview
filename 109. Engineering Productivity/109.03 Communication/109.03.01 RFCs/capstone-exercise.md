# Capstone Exercise: RFCs

## Scenario

You own a cross-team engineering decision where clarity, influence, trade-offs, delivery risk, and long-term ownership matter. You must design, implement, test, operate, and explain RFCs for a production system.
