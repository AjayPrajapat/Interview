# Learning Objectives: Memory and Garbage Collection

## By The End, You Should Be Able To

- Define Memory and Garbage Collection in the context of JavaScript Core without relying on memorized wording.
- Explain why Memory and Garbage Collection belongs under Advanced Runtime Behavior and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Memory and Garbage Collection.
