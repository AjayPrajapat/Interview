# Common Misconceptions: Memory and Garbage Collection
...
Write one sentence explaining what you used to believe about Memory and Garbage Collection, then rewrite it with the production constraint included.
