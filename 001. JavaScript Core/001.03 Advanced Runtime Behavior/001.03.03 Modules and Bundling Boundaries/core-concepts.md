# Core Concepts: Modules and Bundling Boundaries

## Definition

Modules and Bundling Boundaries is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Advanced Runtime Behavior.
...
- It gives engineers a shared vocabulary for reasoning about Advanced Runtime Behavior.
...
Use Modules and Bundling Boundaries to reason about:
...
- The Advanced Runtime Behavior layer decides which path should execute.
