# Debugging Playbook: Modules and Bundling Boundaries

## Start Here

Debug Modules and Bundling Boundaries by moving from symptom to invariant, not from stack trace to guess.
