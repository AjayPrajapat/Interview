# Domain-Specific Examples: Equality and Coercion

## Domain Lens

Category domain: language/runtime engineering

Use Equality and Coercion to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
