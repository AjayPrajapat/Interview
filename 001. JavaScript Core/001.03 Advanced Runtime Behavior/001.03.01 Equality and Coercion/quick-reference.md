# Quick Reference: Equality and Coercion

## Core Definition

Equality and Coercion is a JavaScript Core concept inside Advanced Runtime Behavior that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
