# Common Misconceptions: Error Handling
...
Write one sentence explaining what you used to believe about Error Handling, then rewrite it with the production constraint included.
