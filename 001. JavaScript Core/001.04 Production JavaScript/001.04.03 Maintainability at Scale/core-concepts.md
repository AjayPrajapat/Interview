# Core Concepts: Maintainability at Scale

## Definition

Maintainability at Scale is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Production JavaScript.
...
- It gives engineers a shared vocabulary for reasoning about Production JavaScript.
...
Use Maintainability at Scale to reason about:
...
- The Production JavaScript layer decides which path should execute.
