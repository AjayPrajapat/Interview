# Domain-Specific Examples: Values and Types

## Domain Lens

Category domain: language/runtime engineering

Use Values and Types to reason about a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely.
