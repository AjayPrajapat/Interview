# Learning Objectives: Variables & Declarations

## By The End, You Should Be Able To

- Define Variables & Declarations in the context of JavaScript Core without relying on memorized wording.
- Explain why Variables & Declarations belongs under Language Fundamentals and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Variables & Declarations.
