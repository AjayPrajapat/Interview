# Diagrams: 001.01.02 Scope, Closures, and Hoisting

Category: JavaScript Core

Topic: 001.01 Language Fundamentals

Use these diagrams to understand Scope, Closures, and Hoisting visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.

## 1. Concept Map

```mermaid
flowchart TD
  A["JavaScript Core"] --> B["001.01 Language Fundamentals"]
  B --> C["Scope, Closures, and Hoisting"]
  C --> D["Definition"]
...
flowchart TD
  ...
  C --> D["Apply Scope, Closures, and Hoisting Rules"]
...
```text
Work enters Scope, Closures, and Hoisting
...
sequenceDiagram
  ...
  participant Core as Scope, Closures, and Hoisting
  participant State
...
Do not optimize Scope, Closures, and Hoisting by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Scope, Closures, and Hoisting"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Scope, Closures, and Hoisting"] --> B{"Clear Owner?"}
...
```text
[ ] I can define Scope, Closures, and Hoisting.
