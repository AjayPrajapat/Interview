# Teaching Notes: Scope, Closures, and Hoisting

## Teach To A Beginner

Start with the problem Scope, Closures, and Hoisting solves. Avoid jargon until the learner can explain the basic behavior.
