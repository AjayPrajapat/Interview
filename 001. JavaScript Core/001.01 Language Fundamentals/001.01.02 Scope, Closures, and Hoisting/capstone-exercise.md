# Capstone Exercise: Scope, Closures, and Hoisting

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Scope, Closures, and Hoisting for a production system.
