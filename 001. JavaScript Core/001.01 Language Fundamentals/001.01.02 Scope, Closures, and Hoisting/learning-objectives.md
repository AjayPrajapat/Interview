# Learning Objectives: Scope, Closures, and Hoisting

## By The End, You Should Be Able To

- Define Scope, Closures, and Hoisting in the context of JavaScript Core without relying on memorized wording.
- Explain why Scope, Closures, and Hoisting belongs under Language Fundamentals and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Scope, Closures, and Hoisting.
