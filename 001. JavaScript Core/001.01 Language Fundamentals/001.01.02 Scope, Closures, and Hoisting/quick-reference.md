# Quick Reference: Scope, Closures, and Hoisting

## Core Definition

Scope, Closures, and Hoisting is a JavaScript Core concept inside Language Fundamentals that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Scope, Closures, and Hoisting?
