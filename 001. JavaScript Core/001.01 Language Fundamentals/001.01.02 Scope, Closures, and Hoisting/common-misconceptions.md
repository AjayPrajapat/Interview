# Common Misconceptions: Scope, Closures, and Hoisting
...
Write one sentence explaining what you used to believe about Scope, Closures, and Hoisting, then rewrite it with the production constraint included.
