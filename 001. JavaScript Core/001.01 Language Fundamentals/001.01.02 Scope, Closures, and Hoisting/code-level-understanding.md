# Code-Level Understanding: Scope, Closures, and Hoisting

## Example Exercise

Build a small JavaScript Core example that demonstrates Scope, Closures, and Hoisting with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Scope, Closures, and Hoisting example.
