# Core Concepts: Scope, Closures, and Hoisting

## Definition

Scope, Closures, and Hoisting is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Language Fundamentals.
...
Use Scope, Closures, and Hoisting to reason about:
