# Learning Objectives: Event Loop and Tasks

## By The End, You Should Be Able To

- Define Event Loop and Tasks in the context of JavaScript Core without relying on memorized wording.
- Explain why Event Loop and Tasks belongs under Execution Model and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Event Loop and Tasks.
