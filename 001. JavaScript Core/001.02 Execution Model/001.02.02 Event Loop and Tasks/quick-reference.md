# Quick Reference: Event Loop and Tasks

## Core Definition

Event Loop and Tasks is a JavaScript Core concept inside Execution Model that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
