# Core Concepts: Event Loop and Tasks

## Definition

Event Loop and Tasks is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Execution Model.
...
Use Event Loop and Tasks to reason about:
