# Capstone Exercise: Event Loop and Tasks

## Scenario

You own a shared utility used by browser clients, Node.js services, and test suites where small semantic mistakes spread widely. You must design, implement, test, operate, and explain Event Loop and Tasks for a production system.
