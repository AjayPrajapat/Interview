# Validation Questions: Event Loop and Tasks

## Conceptual Questions

1. What problem does Event Loop and Tasks solve in JavaScript Core?
...
1. A production issue appears only under high traffic. How would you investigate Event Loop and Tasks?
...
2. What metric would move first if Event Loop and Tasks became the bottleneck?

## Mastery Prompt

Explain Event Loop and Tasks from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
