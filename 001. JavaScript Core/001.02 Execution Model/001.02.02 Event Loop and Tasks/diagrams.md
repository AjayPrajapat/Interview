# Diagrams: 001.02.02 Event Loop and Tasks

Category: JavaScript Core

Topic: 001.02 Execution Model

Use these diagrams to understand Event Loop and Tasks visually: normal flow, internal lifecycle, memory/resource behavior, failure handling, debugging, optimization, and system design connections.
...
flowchart TD
  ...
  C --> D["Apply Event Loop and Tasks Rules"]
...
```text
Work enters Event Loop and Tasks
...
sequenceDiagram
  ...
  participant Core as Event Loop and Tasks
  participant State
...
Do not optimize Event Loop and Tasks by intuition alone. Optimize only after measurement identifies the constraint.

## 9. Architecture Decision Map

```mermaid
flowchart TD
  A["Need Event Loop and Tasks"] --> B{"Scope Small?"}
...
```mermaid
flowchart TD
  A["Proposal Uses Event Loop and Tasks"] --> B{"Clear Owner?"}
...
```text
[ ] I can define Event Loop and Tasks.
