# Quick Reference: Promises and Async/Await

## Core Definition

Promises and Async/Await is a JavaScript Core concept inside Execution Model that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
...
- What is Promises and Async/Await?
