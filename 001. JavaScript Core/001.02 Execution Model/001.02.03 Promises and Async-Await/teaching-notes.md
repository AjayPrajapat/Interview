# Teaching Notes: Promises and Async/Await

## Teach To A Beginner

Start with the problem Promises and Async/Await solves. Avoid jargon until the learner can explain the basic behavior.
