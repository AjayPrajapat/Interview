# Core Concepts: Promises and Async/Await

## Definition

Promises and Async/Await is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Execution Model.
...
- It gives engineers a shared vocabulary for reasoning about Execution Model.
...
Use Promises and Async/Await to reason about:
...
- The Execution Model layer decides which path should execute.
