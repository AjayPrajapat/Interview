# Code-Level Understanding: Promises and Async/Await

## Example Exercise

Build a small JavaScript Core example that demonstrates Promises and Async/Await with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Promises and Async/Await example.
