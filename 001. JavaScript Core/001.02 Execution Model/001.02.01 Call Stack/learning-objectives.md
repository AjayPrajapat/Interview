# Learning Objectives: Call Stack

## By The End, You Should Be Able To

- Define Call Stack in the context of JavaScript Core without relying on memorized wording.
- Explain why Call Stack belongs under Execution Model and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Call Stack.
