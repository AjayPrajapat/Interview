# Validation Questions: Call Stack

## Conceptual Questions

1. What problem does Call Stack solve in JavaScript Core?
...
1. A production issue appears only under high traffic. How would you investigate Call Stack?
...
2. What metric would move first if Call Stack became the bottleneck?

## Mastery Prompt

Explain Call Stack from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
