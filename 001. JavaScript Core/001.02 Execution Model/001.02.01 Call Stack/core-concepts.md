# Core Concepts: Call Stack

## Definition

Call Stack is a core part of JavaScript Core that describes a specific behavior, boundary, or engineering decision inside Execution Model.
...
Use Call Stack to reason about:
