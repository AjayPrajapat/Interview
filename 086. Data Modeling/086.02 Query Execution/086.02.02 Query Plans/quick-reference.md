...
Query Plans is a Data Modeling concept inside Query Execution that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
