...
Definitions is a WebSocket / Realtime Systems concept inside Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
