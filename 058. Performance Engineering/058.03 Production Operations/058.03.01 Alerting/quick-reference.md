# Quick Reference: Alerting

## Core Definition

Alerting is a Performance Engineering concept inside Production Operations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
