# Quick Reference: Incident Diagnosis

## Core Definition

Incident Diagnosis is a Performance Engineering concept inside Production Operations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
