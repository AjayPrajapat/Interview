# Code-Level Understanding: Incident Diagnosis

## Example Exercise

Build a small Performance Engineering example that demonstrates Incident Diagnosis with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Incident Diagnosis example.
