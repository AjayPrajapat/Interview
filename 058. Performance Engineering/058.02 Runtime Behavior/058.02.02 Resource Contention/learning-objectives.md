# Learning Objectives: Resource Contention

## By The End, You Should Be Able To

- Define Resource Contention in the context of Performance Engineering without relying on memorized wording.
- Explain why Resource Contention belongs under Runtime Behavior and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Resource Contention.
