# Domain-Specific Examples: Resource Contention

## Domain Lens

Category domain: quality and performance engineering

Use Resource Contention to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
