# Validation Questions: Profiling

## Conceptual Questions

1. What problem does Profiling solve in Performance Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Profiling?
...
2. What metric would move first if Profiling became the bottleneck?

## Mastery Prompt

Explain Profiling from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
