# Core Concepts: Metrics and SLIs

## Definition

Metrics and SLIs is a core part of Performance Engineering that describes a specific behavior, boundary, or engineering decision inside Foundations.
...
Use Metrics and SLIs to reason about:
