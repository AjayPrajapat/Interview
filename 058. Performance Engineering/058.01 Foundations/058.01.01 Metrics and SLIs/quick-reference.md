# Quick Reference: Metrics and SLIs

## Core Definition

Metrics and SLIs is a Performance Engineering concept inside Foundations that should be understood through its boundary, invariant, execution flow, failure behavior, and trade-offs.
