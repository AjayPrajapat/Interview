# Validation Questions: Metrics and SLIs

## Conceptual Questions

1. What problem does Metrics and SLIs solve in Performance Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Metrics and SLIs?
...
2. What metric would move first if Metrics and SLIs became the bottleneck?

## Mastery Prompt

Explain Metrics and SLIs from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
