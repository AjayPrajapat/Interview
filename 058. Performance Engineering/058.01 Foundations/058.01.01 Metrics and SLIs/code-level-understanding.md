# Code-Level Understanding: Metrics and SLIs

## Example Exercise

Build a small Performance Engineering example that demonstrates Metrics and SLIs with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Metrics and SLIs example.
