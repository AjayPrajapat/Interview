# Learning Objectives: Metrics and SLIs

## By The End, You Should Be Able To

- Define Metrics and SLIs in the context of Performance Engineering without relying on memorized wording.
- Explain why Metrics and SLIs belongs under Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Metrics and SLIs.
