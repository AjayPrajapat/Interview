# Code-Level Understanding: Capacity Limits

## Example Exercise

Build a small Performance Engineering example that demonstrates Capacity Limits with:
...
export function handle(input: Input): Result {
  ...
  try {
    // Replace this block with a concrete Capacity Limits example.
