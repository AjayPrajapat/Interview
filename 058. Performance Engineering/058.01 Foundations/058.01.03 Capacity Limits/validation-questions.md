# Validation Questions: Capacity Limits

## Conceptual Questions

1. What problem does Capacity Limits solve in Performance Engineering?
...
1. A production issue appears only under high traffic. How would you investigate Capacity Limits?
...
2. What metric would move first if Capacity Limits became the bottleneck?

## Mastery Prompt

Explain Capacity Limits from beginner level to staff level in under five minutes, including one code-level detail and one production trade-off.
