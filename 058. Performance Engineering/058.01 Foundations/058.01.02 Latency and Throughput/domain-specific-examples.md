# Domain-Specific Examples: Latency and Throughput

## Domain Lens

Category domain: quality and performance engineering

Use Latency and Throughput to reason about a critical workflow where tests, profiling, concurrency control, and failure injection prevent production regressions.
