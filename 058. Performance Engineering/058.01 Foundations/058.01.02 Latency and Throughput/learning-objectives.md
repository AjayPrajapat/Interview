# Learning Objectives: Latency and Throughput

## By The End, You Should Be Able To

- Define Latency and Throughput in the context of Performance Engineering without relying on memorized wording.
- Explain why Latency and Throughput belongs under Foundations and what dependency it creates for later topics.
- Trace the normal flow, edge-case flow, and failure flow.
- Recognize common production symptoms related to Latency and Throughput.
