# Diagrams: 108.01.03 Influence Without Authority
...
```mermaid
flowchart TD
  A["Cross/Team Collaboration"] --> B["108.01 Technical Leadership"]
...
For Cross/Team Collaboration, pay special attention to:
